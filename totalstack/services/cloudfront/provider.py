"""Auto-wired TotalStack provider for cloudfront."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "cloudfront")
...
class TotalStackCloudfrontProvider:
    """Auto-wired provider for cloudfront."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackCloudfrontProvider, _method, _attach_handler(_op, _method, _fn))
