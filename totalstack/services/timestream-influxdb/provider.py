"""Auto-wired TotalStack provider for timestream-influxdb."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "timestream-influxdb")
...
class TotalStackTimestreamInfluxdbProvider:
    """Auto-wired provider for timestream-influxdb."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackTimestreamInfluxdbProvider, _method, _attach_handler(_op, _method, _fn))
