"""Auto-wired TotalStack provider for grafana."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "grafana")
...
class TotalStackGrafanaProvider:
    """Auto-wired provider for grafana."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackGrafanaProvider, _method, _attach_handler(_op, _method, _fn))
