"""Auto-wired TotalStack provider for codebuild."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "codebuild")
...
class TotalStackCodebuildProvider:
    """Auto-wired provider for codebuild."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackCodebuildProvider, _method, _attach_handler(_op, _method, _fn))
