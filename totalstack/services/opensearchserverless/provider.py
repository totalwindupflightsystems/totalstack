"""Auto-wired TotalStack provider for opensearchserverless."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "opensearchserverless")
...
class TotalStackOpensearchserverlessProvider:
    """Auto-wired provider for opensearchserverless."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackOpensearchserverlessProvider, _method, _attach_handler(_op, _method, _fn))
