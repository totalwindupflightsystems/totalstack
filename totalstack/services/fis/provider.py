"""Auto-wired TotalStack provider for fis."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "fis")
...
class TotalStackFisProvider:
    """Auto-wired provider for fis."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackFisProvider, _method, _attach_handler(_op, _method, _fn))
