"""Auto-wired TotalStack provider for iot-data."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "iot-data")
...
class TotalStackIotDataProvider:
    """Auto-wired provider for iot-data."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackIotDataProvider, _method, _attach_handler(_op, _method, _fn))
