"""Auto-wired TotalStack provider for memorydb."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "memorydb")
...
class TotalStackMemorydbProvider:
    """Auto-wired provider for memorydb."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackMemorydbProvider, _method, _attach_handler(_op, _method, _fn))
