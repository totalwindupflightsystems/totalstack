"""Auto-wired TotalStack provider for quicksight."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "quicksight")
...
class TotalStackQuicksightProvider:
    """Auto-wired provider for quicksight."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackQuicksightProvider, _method, _attach_handler(_op, _method, _fn))
