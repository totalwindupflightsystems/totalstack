"""Auto-wired TotalStack provider for bedrock-runtime."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "bedrock-runtime")
...
class TotalStackBedrockRuntimeProvider:
    """Auto-wired provider for bedrock-runtime."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackBedrockRuntimeProvider, _method, _attach_handler(_op, _method, _fn))
