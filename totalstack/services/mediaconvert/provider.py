"""Auto-wired TotalStack provider for mediaconvert."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "mediaconvert")
...
class TotalStackMediaconvertProvider:
    """Auto-wired provider for mediaconvert."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackMediaconvertProvider, _method, _attach_handler(_op, _method, _fn))
