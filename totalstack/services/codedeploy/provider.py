"""Auto-wired TotalStack provider for codedeploy."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "codedeploy")
...
class TotalStackCodedeployProvider:
    """Auto-wired provider for codedeploy."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackCodedeployProvider, _method, _attach_handler(_op, _method, _fn))
