"""Auto-wired TotalStack provider for neptune."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "neptune")
...
class TotalStackNeptuneProvider:
    """Auto-wired provider for neptune."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackNeptuneProvider, _method, _attach_handler(_op, _method, _fn))
