"""Auto-wired TotalStack provider for mwaa."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "mwaa")
...
class TotalStackMwaaProvider:
    """Auto-wired provider for mwaa."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackMwaaProvider, _method, _attach_handler(_op, _method, _fn))
