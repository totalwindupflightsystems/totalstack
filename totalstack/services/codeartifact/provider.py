"""Auto-wired TotalStack provider for codeartifact."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "codeartifact")
...
class TotalStackCodeartifactProvider:
    """Auto-wired provider for codeartifact."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackCodeartifactProvider, _method, _attach_handler(_op, _method, _fn))
