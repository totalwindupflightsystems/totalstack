"""Auto-wired TotalStack provider for datasync."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "datasync")
...
class TotalStackDatasyncProvider:
    """Auto-wired provider for datasync."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackDatasyncProvider, _method, _attach_handler(_op, _method, _fn))
