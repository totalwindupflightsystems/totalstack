"""Auto-wired TotalStack provider for codepipeline."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "codepipeline")
...
class TotalStackCodepipelineProvider:
    """Auto-wired provider for codepipeline."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackCodepipelineProvider, _method, _attach_handler(_op, _method, _fn))
