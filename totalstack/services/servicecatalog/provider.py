"""Auto-wired TotalStack provider for servicecatalog."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "servicecatalog")
...
class TotalStackServicecatalogProvider:
    """Auto-wired provider for servicecatalog."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackServicecatalogProvider, _method, _attach_handler(_op, _method, _fn))
