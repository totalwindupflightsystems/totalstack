"""Auto-wired TotalStack provider for appconfig."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "appconfig")
...
class TotalStackAppconfigProvider:
    """Auto-wired provider for appconfig."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackAppconfigProvider, _method, _attach_handler(_op, _method, _fn))
