"""Auto-wired TotalStack provider for comprehend."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "comprehend")
...
class TotalStackComprehendProvider:
    """Auto-wired provider for comprehend."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackComprehendProvider, _method, _attach_handler(_op, _method, _fn))
