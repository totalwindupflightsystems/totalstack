"""Auto-wired TotalStack provider for verifiedpermissions."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "verifiedpermissions")
...
class TotalStackVerifiedpermissionsProvider:
    """Auto-wired provider for verifiedpermissions."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackVerifiedpermissionsProvider, _method, _attach_handler(_op, _method, _fn))
