"""Auto-wired TotalStack provider for s3tables."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "s3tables")
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackS3tablesProvider, _method, _attach_handler(_op, _method, _fn))
