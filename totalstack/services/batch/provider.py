"""Auto-wired TotalStack provider for batch."""
...
class TotalStackBatchProvider:
    """Auto-wired provider for batch."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackBatchProvider, _method, _attach_handler(_op, _method, _fn))
