"""Auto-wired TotalStack provider for amplify."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "amplify")
...
class TotalStackAmplifyProvider:
    """Auto-wired provider for amplify."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackAmplifyProvider, _method, _attach_handler(_op, _method, _fn))
