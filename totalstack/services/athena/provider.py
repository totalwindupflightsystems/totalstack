"""Auto-wired TotalStack provider for athena."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "athena")
...
class TotalStackAthenaProvider:
    """Auto-wired provider for athena."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackAthenaProvider, _method, _attach_handler(_op, _method, _fn))
