"""Auto-wired TotalStack provider for shield."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "shield")
...
class TotalStackShieldProvider:
    """Auto-wired provider for shield."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackShieldProvider, _method, _attach_handler(_op, _method, _fn))
