"""Auto-wired TotalStack provider for dms."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "dms")
...
class TotalStackDmsProvider:
    """Auto-wired provider for dms."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackDmsProvider, _method, _attach_handler(_op, _method, _fn))
