"""Auto-wired TotalStack provider for kendra."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "kendra")
...
class TotalStackKendraProvider:
    """Auto-wired provider for kendra."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackKendraProvider, _method, _attach_handler(_op, _method, _fn))
