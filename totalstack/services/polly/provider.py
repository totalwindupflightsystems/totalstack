"""Auto-wired TotalStack provider for polly."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "polly")
...
class TotalStackPollyProvider:
    """Auto-wired provider for polly."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackPollyProvider, _method, _attach_handler(_op, _method, _fn))
