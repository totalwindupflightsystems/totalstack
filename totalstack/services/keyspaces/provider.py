"""Auto-wired TotalStack provider for keyspaces."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "keyspaces")
...
class TotalStackKeyspacesProvider:
    """Auto-wired provider for keyspaces."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackKeyspacesProvider, _method, _attach_handler(_op, _method, _fn))
