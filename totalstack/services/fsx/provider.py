"""Auto-wired TotalStack provider for fsx."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "fsx")
...
class TotalStackFsxProvider:
    """Auto-wired provider for fsx."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackFsxProvider, _method, _attach_handler(_op, _method, _fn))
