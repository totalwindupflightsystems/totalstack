"""Auto-wired TotalStack provider for efs."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "efs")
...
class TotalStackEfsProvider:
    """Auto-wired provider for efs."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackEfsProvider, _method, _attach_handler(_op, _method, _fn))
