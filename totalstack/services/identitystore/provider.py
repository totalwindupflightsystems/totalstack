"""Auto-wired TotalStack provider for identitystore."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "identitystore")
...
class TotalStackIdentitystoreProvider:
    """Auto-wired provider for identitystore."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackIdentitystoreProvider, _method, _attach_handler(_op, _method, _fn))
