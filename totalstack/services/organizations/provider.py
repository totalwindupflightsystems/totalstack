"""Auto-wired TotalStack provider for organizations."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "organizations")
...
class TotalStackOrganizationsProvider:
    """Auto-wired provider for organizations."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackOrganizationsProvider, _method, _attach_handler(_op, _method, _fn))
