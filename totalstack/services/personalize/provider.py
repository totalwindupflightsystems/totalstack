"""Auto-wired TotalStack provider for personalize."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "personalize")
...
class TotalStackPersonalizeProvider:
    """Auto-wired provider for personalize."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackPersonalizeProvider, _method, _attach_handler(_op, _method, _fn))
