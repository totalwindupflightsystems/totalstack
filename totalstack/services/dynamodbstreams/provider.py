"""Auto-wired TotalStack provider for dynamodbstreams."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "dynamodbstreams")
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackDynamodbstreamsProvider, _method, _attach_handler(_op, _method, _fn))
