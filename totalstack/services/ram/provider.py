"""Auto-wired TotalStack provider for ram."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "ram")
...
class TotalStackRamProvider:
    """Auto-wired provider for ram."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackRamProvider, _method, _attach_handler(_op, _method, _fn))
