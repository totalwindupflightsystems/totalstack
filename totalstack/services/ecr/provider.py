"""Auto-wired TotalStack provider for ecr."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "ecr")
...
class TotalStackEcrProvider:
    """Auto-wired provider for ecr."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackEcrProvider, _method, _attach_handler(_op, _method, _fn))
