"""Auto-wired TotalStack provider for backup."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "backup")
...
class TotalStackBackupProvider:
    """Auto-wired provider for backup."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackBackupProvider, _method, _attach_handler(_op, _method, _fn))
