"""Auto-wired TotalStack provider for sesv2."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "sesv2")
...
class TotalStackSesv2Provider:
    """Auto-wired provider for sesv2."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackSesv2Provider, _method, _attach_handler(_op, _method, _fn))
