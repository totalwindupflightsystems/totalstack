"""Auto-wired TotalStack provider for sso-admin."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "sso-admin")
...
class TotalStackSsoAdminProvider:
    """Auto-wired provider for sso-admin."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackSsoAdminProvider, _method, _attach_handler(_op, _method, _fn))
