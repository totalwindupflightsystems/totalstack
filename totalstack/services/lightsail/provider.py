"""Auto-wired TotalStack provider for lightsail."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "lightsail")
...
class TotalStackLightsailProvider:
    """Auto-wired provider for lightsail."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackLightsailProvider, _method, _attach_handler(_op, _method, _fn))
