"""Auto-wired TotalStack provider for application-autoscaling."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "application-autoscaling")
...
class TotalStackApplicationAutoscalingProvider:
    """Auto-wired provider for application-autoscaling."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackApplicationAutoscalingProvider, _method, _attach_handler(_op, _method, _fn))
