"""Auto-wired TotalStack provider for mq."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "mq")
...
class TotalStackMqProvider:
    """Auto-wired provider for mq."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackMqProvider, _method, _attach_handler(_op, _method, _fn))
