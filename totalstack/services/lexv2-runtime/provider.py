"""Auto-wired TotalStack provider for lexv2-runtime."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "lexv2-runtime")
...
class TotalStackLexv2RuntimeProvider:
    """Auto-wired provider for lexv2-runtime."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackLexv2RuntimeProvider, _method, _attach_handler(_op, _method, _fn))
