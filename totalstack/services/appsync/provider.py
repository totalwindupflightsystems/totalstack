"""Auto-wired TotalStack provider for appsync."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "appsync")
...
class TotalStackAppsyncProvider:
    """Auto-wired provider for appsync."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackAppsyncProvider, _method, _attach_handler(_op, _method, _fn))
