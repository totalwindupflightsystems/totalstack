"""Auto-wired TotalStack provider for transcribe."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "transcribe")
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackTranscribeProvider, _method, _attach_handler(_op, _method, _fn))
