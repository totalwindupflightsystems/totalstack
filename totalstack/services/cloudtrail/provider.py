"""Auto-wired TotalStack provider for cloudtrail."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "cloudtrail")
...
class TotalStackCloudtrailProvider:
    """Auto-wired provider for cloudtrail."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackCloudtrailProvider, _method, _attach_handler(_op, _method, _fn))
