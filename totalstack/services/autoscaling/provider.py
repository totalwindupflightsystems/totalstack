"""Auto-wired TotalStack provider for autoscaling."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "autoscaling")
...
class TotalStackAutoscalingProvider:
    """Auto-wired provider for autoscaling."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackAutoscalingProvider, _method, _attach_handler(_op, _method, _fn))
