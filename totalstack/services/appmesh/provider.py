"""Auto-wired TotalStack provider for appmesh."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "appmesh")
...
class TotalStackAppmeshProvider:
    """Auto-wired provider for appmesh."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackAppmeshProvider, _method, _attach_handler(_op, _method, _fn))
