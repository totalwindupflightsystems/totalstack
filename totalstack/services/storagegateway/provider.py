"""Auto-wired TotalStack provider for storagegateway."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "storagegateway")
...
class TotalStackStoragegatewayProvider:
    """Auto-wired provider for storagegateway."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackStoragegatewayProvider, _method, _attach_handler(_op, _method, _fn))
