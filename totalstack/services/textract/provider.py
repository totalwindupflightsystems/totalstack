"""Auto-wired TotalStack provider for textract."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "textract")
...
class TotalStackTextractProvider:
    """Auto-wired provider for textract."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackTextractProvider, _method, _attach_handler(_op, _method, _fn))
