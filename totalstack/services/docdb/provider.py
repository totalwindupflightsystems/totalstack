"""Auto-wired TotalStack provider for docdb."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "docdb")
...
class TotalStackDocdbProvider:
    """Auto-wired provider for docdb."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackDocdbProvider, _method, _attach_handler(_op, _method, _fn))
