"""Auto-wired TotalStack provider for greengrassv2."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "greengrassv2")
...
class TotalStackGreengrassv2Provider:
    """Auto-wired provider for greengrassv2."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackGreengrassv2Provider, _method, _attach_handler(_op, _method, _fn))
