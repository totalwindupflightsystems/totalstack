"""Auto-wired TotalStack provider for signer."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "signer")
...
class TotalStackSignerProvider:
    """Auto-wired provider for signer."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackSignerProvider, _method, _attach_handler(_op, _method, _fn))
