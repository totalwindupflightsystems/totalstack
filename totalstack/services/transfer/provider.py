"""Auto-wired TotalStack provider for transfer."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "transfer")
...
class TotalStackTransferProvider:
    """Auto-wired provider for transfer."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackTransferProvider, _method, _attach_handler(_op, _method, _fn))
