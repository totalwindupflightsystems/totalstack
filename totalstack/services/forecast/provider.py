"""Auto-wired TotalStack provider for forecast."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "forecast")
...
class TotalStackForecastProvider:
    """Auto-wired provider for forecast."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackForecastProvider, _method, _attach_handler(_op, _method, _fn))
