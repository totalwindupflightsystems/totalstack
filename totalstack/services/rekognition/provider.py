"""Auto-wired TotalStack provider for rekognition."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "rekognition")
...
class TotalStackRekognitionProvider:
    """Auto-wired provider for rekognition."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackRekognitionProvider, _method, _attach_handler(_op, _method, _fn))
