"""Auto-wired TotalStack provider for iot."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "iot")
...
class TotalStackIotProvider:
    """Auto-wired provider for iot."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackIotProvider, _method, _attach_handler(_op, _method, _fn))
