...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "frauddetector")
...
class TotalStackFrauddetectorProvider:
    """Auto-wired provider for frauddetector."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackFrauddetectorProvider, _method, _attach_handler(_op, _method, _fn))
