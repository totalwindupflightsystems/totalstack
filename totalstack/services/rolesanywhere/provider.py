"""Auto-wired TotalStack provider for rolesanywhere."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "rolesanywhere")
...
class TotalStackRolesanywhereProvider:
    """Auto-wired provider for rolesanywhere."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackRolesanywhereProvider, _method, _attach_handler(_op, _method, _fn))
