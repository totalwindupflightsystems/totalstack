"""Auto-wired TotalStack provider for globalaccelerator."""
...
_SVC = os.path.join(_ROOT, "specs", "aws", ".speclang", "assembled", "globalaccelerator")
...
class TotalStackGlobalacceleratorProvider:
    """Auto-wired provider for globalaccelerator."""
...
for _op, (_method, _fn) in _HANDLERS.items():
    setattr(TotalStackGlobalacceleratorProvider, _method, _attach_handler(_op, _method, _fn))
