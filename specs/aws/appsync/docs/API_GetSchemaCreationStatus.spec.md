---
id: "@specs/aws/appsync/docs/API_GetSchemaCreationStatus"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS GetSchemaCreationStatus"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appsync/docs/API_GetSchemaCreationStatus
...
The current state of the schema (PROCESSING, FAILED, SUCCESS, or NOT\_APPLICABLE). When the schema is in the ACTIVE state, you can add data.  
Type: String  
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/appsync-2017-07-25/GetSchemaCreationStatus) 
