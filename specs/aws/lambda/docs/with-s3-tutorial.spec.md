---
id: "@specs/aws/lambda/docs/with-s3-tutorial"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Tutorial: Use an Amazon S3 trigger to create thumbnails"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lambda/docs/with-s3-tutorial
