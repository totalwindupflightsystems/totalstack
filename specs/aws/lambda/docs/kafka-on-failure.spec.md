---
id: "@specs/aws/lambda/docs/kafka-on-failure"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Retain failed invocations"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lambda/docs/kafka-on-failure
