---
id: "@specs/aws/lambda/docs/services-consume-kafka-events"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Schema registries with event sources"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lambda/docs/services-consume-kafka-events
