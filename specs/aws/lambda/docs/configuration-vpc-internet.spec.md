---
id: "@specs/aws/lambda/docs/configuration-vpc-internet"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Internet access for VPC functions"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lambda/docs/configuration-vpc-internet
