---
id: "@specs/aws/wafv2/docs/API_waf_CreateWebACLMigrationStack"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
...
> **spec:id:** @specs/aws/wafv2/docs/API_waf_CreateWebACLMigrationStack
> **target_lang:** meta — documentation tier. ALL sections preserved.



# CreateWebACLMigrationStack
<a name="API_waf_CreateWebACLMigrationStack"></a>
...
## Request Syntax
<a name="API_waf_CreateWebACLMigrationStack_RequestSyntax"></a>
...
## Request Parameters
<a name="API_waf_CreateWebACLMigrationStack_RequestParameters"></a>

For information about the parameters that are common to all actions, see [Common Parameters](CommonParameters.md).

The request accepts the following data in JSON format.

 ** [IgnoreUnsupportedType](#API_waf_CreateWebACLMigrationStack_RequestSyntax) **   <a name="WAF-waf_CreateWebACLMigrationStack-request-IgnoreUnsupportedType"></a>
Indicates whether to exclude entities that can't be migrated or to stop the migration. Set this to true to ignore unsupported entities in the web ACL during the migration. Otherwise, if AWS WAF encounters unsupported entities, it stops the process and throws an exception.   
Type: Boolean  
Required: Yes

 ** [S3BucketName](#API_waf_CreateWebACLMigrationStack_RequestSyntax) **   <a name="WAF-waf_CreateWebACLMigrationStack-request-S3BucketName"></a>
 ...
 ** [WebACLId](#API_waf_CreateWebACLMigrationStack_RequestSyntax) **   <a name="WAF-waf_CreateWebACLMigrationStack-request-WebACLId"></a>
...
## Response Syntax
<a name="API_waf_CreateWebACLMigrationStack_ResponseSyntax"></a>
...
## Response Elements
<a name="API_waf_CreateWebACLMigrationStack_ResponseElements"></a>

If the action is successful, the service sends back an HTTP 200 response.

The following data is returned in JSON format by the service.

 ** [S3ObjectUrl](#API_waf_CreateWebACLMigrationStack_ResponseSyntax) **   <a name="WAF-waf_CreateWebACLMigrationStack-response-S3ObjectUrl"></a>
The URL of the template created in Amazon S3.   
Type: String  
Length Constraints: Minimum length of 1.

## Errors
<a name="API_waf_CreateWebACLMigrationStack_Errors"></a>
...
## Examples
<a name="API_waf_CreateWebACLMigrationStack_Examples"></a>

### Amazon S3 bucket policy for global Amazon CloudFront applications
<a name="API_waf_CreateWebACLMigrationStack_Example_1"></a>
...
<a name="API_waf_CreateWebACLMigrationStack_Example_2"></a>
...
## See Also
<a name="API_waf_CreateWebACLMigrationStack_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS Command Line Interface V2](https://docs.aws.amazon.com/goto/cli2/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for .NET V4](https://docs.aws.amazon.com/goto/DotNetSDKV4/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for Go v2](https://docs.aws.amazon.com/goto/SdkForGoV2/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for JavaScript V3](https://docs.aws.amazon.com/goto/SdkForJavaScriptV3/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for Kotlin](https://docs.aws.amazon.com/goto/SdkForKotlin/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for PHP V3](https://docs.aws.amazon.com/goto/SdkForPHPV3/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for Python](https://docs.aws.amazon.com/goto/boto3/waf-2015-08-24/CreateWebACLMigrationStack) 
+  [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/waf-2015-08-24/CreateWebACLMigrationStack) 