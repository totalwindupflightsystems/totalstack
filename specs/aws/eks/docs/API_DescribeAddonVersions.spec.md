---
id: "@specs/aws/eks/docs/API_DescribeAddonVersions"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DescribeAddonVersions"
status: active
depends_on:
  - "@specs/aws/eks/meta"
---
...
> **spec:id:** @specs/aws/eks/docs/API_DescribeAddonVersions
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DescribeAddonVersions
<a name="API_DescribeAddonVersions"></a>
...
## Request Syntax
<a name="API_DescribeAddonVersions_RequestSyntax"></a>
...
<a name="API_DescribeAddonVersions_RequestParameters"></a>
...
## Request Body
<a name="API_DescribeAddonVersions_RequestBody"></a>

The request does not have a request body.

## Response Syntax
<a name="API_DescribeAddonVersions_ResponseSyntax"></a>
...
## Response Elements
<a name="API_DescribeAddonVersions_ResponseElements"></a>
...
## Errors
<a name="API_DescribeAddonVersions_Errors"></a>
...
## Examples
<a name="API_DescribeAddonVersions_Examples"></a>
...
### Example
<a name="API_DescribeAddonVersions_Example_1"></a>

The following example describes the add-on versions available for an add-on named `vpc-cni`.

#### Sample Request
<a name="API_DescribeAddonVersions_Example_1_Request"></a>
...
#### Sample Response
<a name="API_DescribeAddonVersions_Example_1_Response"></a>
...
## See Also
<a name="API_DescribeAddonVersions_SeeAlso"></a>
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/eks-2017-11-01/DescribeAddonVersions) 
