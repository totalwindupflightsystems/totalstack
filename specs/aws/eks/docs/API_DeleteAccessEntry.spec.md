---
id: "@specs/aws/eks/docs/API_DeleteAccessEntry"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DeleteAccessEntry"
status: active
depends_on:
  - "@specs/aws/eks/meta"
---
...
> **spec:id:** @specs/aws/eks/docs/API_DeleteAccessEntry
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DeleteAccessEntry
<a name="API_DeleteAccessEntry"></a>
...
## Request Syntax
<a name="API_DeleteAccessEntry_RequestSyntax"></a>
...
<a name="API_DeleteAccessEntry_RequestParameters"></a>
...
## Request Body
<a name="API_DeleteAccessEntry_RequestBody"></a>

The request does not have a request body.

## Response Syntax
<a name="API_DeleteAccessEntry_ResponseSyntax"></a>
...
## Response Elements
<a name="API_DeleteAccessEntry_ResponseElements"></a>

If the action is successful, the service sends back an HTTP 200 response with an empty HTTP body.

## Errors
<a name="API_DeleteAccessEntry_Errors"></a>
...
## Examples
<a name="API_DeleteAccessEntry_Examples"></a>
...
### Example
<a name="API_DeleteAccessEntry_Example_1"></a>

The following example deletes an access entry.

#### Sample Request
<a name="API_DeleteAccessEntry_Example_1_Request"></a>
...
#### Sample Response
<a name="API_DeleteAccessEntry_Example_1_Response"></a>
...
## See Also
<a name="API_DeleteAccessEntry_SeeAlso"></a>
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/eks-2017-11-01/DeleteAccessEntry) 
