---
id: "@specs/aws/comprehend/docs/API_DescribeSentimentDetectionJob"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DescribeSentimentDetectionJob"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_DescribeSentimentDetectionJob
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DescribeSentimentDetectionJob
<a name="API_DescribeSentimentDetectionJob"></a>

Gets the properties associated with a sentiment detection job. Use this operation to get the status of a detection job.

## Request Syntax
<a name="API_DescribeSentimentDetectionJob_RequestSyntax"></a>
...
## Request Parameters
<a name="API_DescribeSentimentDetectionJob_RequestParameters"></a>
...
## Response Syntax
<a name="API_DescribeSentimentDetectionJob_ResponseSyntax"></a>
...
## Response Elements
<a name="API_DescribeSentimentDetectionJob_ResponseElements"></a>
...
## Errors
<a name="API_DescribeSentimentDetectionJob_Errors"></a>
...
## See Also
<a name="API_DescribeSentimentDetectionJob_SeeAlso"></a>
