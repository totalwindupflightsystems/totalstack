---
id: "@specs/aws/comprehend/docs/API_EntityRecognizerEvaluationMetrics"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS EntityRecognizerEvaluationMetrics"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_EntityRecognizerEvaluationMetrics
> **target_lang:** meta — documentation tier. ALL sections preserved.



# EntityRecognizerEvaluationMetrics
<a name="API_EntityRecognizerEvaluationMetrics"></a>

Detailed information about the accuracy of an entity recognizer. 

## Contents
<a name="API_EntityRecognizerEvaluationMetrics_Contents"></a>
...
## See Also
<a name="API_EntityRecognizerEvaluationMetrics_SeeAlso"></a>
