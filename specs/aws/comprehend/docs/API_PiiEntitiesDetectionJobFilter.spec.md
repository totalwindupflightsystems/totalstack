---
id: "@specs/aws/comprehend/docs/API_PiiEntitiesDetectionJobFilter"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS PiiEntitiesDetectionJobFilter"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_PiiEntitiesDetectionJobFilter
> **target_lang:** meta — documentation tier. ALL sections preserved.



# PiiEntitiesDetectionJobFilter
<a name="API_PiiEntitiesDetectionJobFilter"></a>

Provides information for filtering a list of PII entity detection jobs.

## Contents
<a name="API_PiiEntitiesDetectionJobFilter_Contents"></a>
...
## See Also
<a name="API_PiiEntitiesDetectionJobFilter_SeeAlso"></a>
