---
id: "@specs/aws/comprehend/docs/API_ClassifierEvaluationMetrics"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS ClassifierEvaluationMetrics"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_ClassifierEvaluationMetrics
> **target_lang:** meta — documentation tier. ALL sections preserved.



# ClassifierEvaluationMetrics
<a name="API_ClassifierEvaluationMetrics"></a>

Describes the result metrics for the test data associated with an documentation classifier.

## Contents
<a name="API_ClassifierEvaluationMetrics_Contents"></a>
...
## See Also
<a name="API_ClassifierEvaluationMetrics_SeeAlso"></a>
