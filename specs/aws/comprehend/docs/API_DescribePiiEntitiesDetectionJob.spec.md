---
id: "@specs/aws/comprehend/docs/API_DescribePiiEntitiesDetectionJob"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DescribePiiEntitiesDetectionJob"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_DescribePiiEntitiesDetectionJob
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DescribePiiEntitiesDetectionJob
<a name="API_DescribePiiEntitiesDetectionJob"></a>

Gets the properties associated with a PII entities detection job. For example, you can use this operation to get the job status.

## Request Syntax
<a name="API_DescribePiiEntitiesDetectionJob_RequestSyntax"></a>
...
## Request Parameters
<a name="API_DescribePiiEntitiesDetectionJob_RequestParameters"></a>
...
## Response Syntax
<a name="API_DescribePiiEntitiesDetectionJob_ResponseSyntax"></a>
...
## Response Elements
<a name="API_DescribePiiEntitiesDetectionJob_ResponseElements"></a>
...
## Errors
<a name="API_DescribePiiEntitiesDetectionJob_Errors"></a>
...
## See Also
<a name="API_DescribePiiEntitiesDetectionJob_SeeAlso"></a>
