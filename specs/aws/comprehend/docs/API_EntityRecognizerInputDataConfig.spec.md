---
id: "@specs/aws/comprehend/docs/API_EntityRecognizerInputDataConfig"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS EntityRecognizerInputDataConfig"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_EntityRecognizerInputDataConfig
> **target_lang:** meta — documentation tier. ALL sections preserved.



# EntityRecognizerInputDataConfig
<a name="API_EntityRecognizerInputDataConfig"></a>

Specifies the format and location of the input data.

## Contents
<a name="API_EntityRecognizerInputDataConfig_Contents"></a>
...
## See Also
<a name="API_EntityRecognizerInputDataConfig_SeeAlso"></a>
