---
id: "@specs/aws/comprehend/docs/API_DescribeDominantLanguageDetectionJob"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DescribeDominantLanguageDetectionJob"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_DescribeDominantLanguageDetectionJob
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DescribeDominantLanguageDetectionJob
<a name="API_DescribeDominantLanguageDetectionJob"></a>

Gets the properties associated with a dominant language detection job. Use this operation to get the status of a detection job.

## Request Syntax
<a name="API_DescribeDominantLanguageDetectionJob_RequestSyntax"></a>
...
## Request Parameters
<a name="API_DescribeDominantLanguageDetectionJob_RequestParameters"></a>
...
## Response Syntax
<a name="API_DescribeDominantLanguageDetectionJob_ResponseSyntax"></a>
...
## Response Elements
<a name="API_DescribeDominantLanguageDetectionJob_ResponseElements"></a>
...
## Errors
<a name="API_DescribeDominantLanguageDetectionJob_Errors"></a>
...
## See Also
<a name="API_DescribeDominantLanguageDetectionJob_SeeAlso"></a>
