---
id: "@specs/aws/comprehend/docs/API_EntityRecognizerDocuments"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS EntityRecognizerDocuments"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_EntityRecognizerDocuments
> **target_lang:** meta — documentation tier. ALL sections preserved.



# EntityRecognizerDocuments
<a name="API_EntityRecognizerDocuments"></a>

Describes the training documents submitted with an entity recognizer.

## Contents
<a name="API_EntityRecognizerDocuments_Contents"></a>
...
## See Also
<a name="API_EntityRecognizerDocuments_SeeAlso"></a>
