---
id: "@specs/aws/comprehend/docs/API_SyntaxToken"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS SyntaxToken"
status: active
depends_on:
...
> **spec:id:** @specs/aws/comprehend/docs/API_SyntaxToken
> **target_lang:** meta — documentation tier. ALL sections preserved.



# SyntaxToken
<a name="API_SyntaxToken"></a>

Represents a work in the input text that was recognized and assigned a part of speech. There is one syntax token record for each word in the source text.

## Contents
<a name="API_SyntaxToken_Contents"></a>
...
## See Also
<a name="API_SyntaxToken_SeeAlso"></a>
