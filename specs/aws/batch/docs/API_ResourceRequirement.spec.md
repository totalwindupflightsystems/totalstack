---
id: "@specs/aws/batch/docs/API_ResourceRequirement"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS ResourceRequirement"
status: active
depends_on:
...
> **spec:id:** @specs/aws/batch/docs/API_ResourceRequirement
 ...
 ** type **   <a name="Batch-Type-ResourceRequirement-type"></a>
The type of resource to assign to a container. The supported resources include `GPU`, `MEMORY`, and `VCPU`.  
Type: String  
Valid Values: `GPU | VCPU | MEMORY`   
Required: Yes

 ** value **   <a name="Batch-Type-ResourceRequirement-value"></a>
...
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/batch-2016-08-10/ResourceRequirement) 
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/batch-2016-08-10/ResourceRequirement) 
+  [AWS SDK for Ruby V3](https://docs.aws.amazon.com/goto/SdkForRubyV3/batch-2016-08-10/ResourceRequirement) 