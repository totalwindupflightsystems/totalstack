"""ListOrganizationalUnitsForParent handler."""


def handle_list_organizational_units_for_parent(store, request: dict) -> dict:
    ...
    result = store.list_organizational_units_for_parent(
