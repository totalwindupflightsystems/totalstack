---
id: "@specs/aws/athena/list-table-metadata"
version: 1.0.0
target_lang: py
output: specs/aws/.speclang/assembled/athena/ListTableMetadata.code.py
owned-by: codegen
status: active
depends_on:
  - "@specs/aws/athena/plan"
---
# ListTableMetadata — Athena

Lists table metadata in a database.
