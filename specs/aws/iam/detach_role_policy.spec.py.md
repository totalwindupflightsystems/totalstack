---
id: "@specs/aws/iam/detach_role_policy"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  - "@specs/aws/iam/plan"
  - "@specs/aws/iam/docs/API_DetachRolePolicy"
---

# DetachRolePolicy

> **spec:trace:** specs/aws/iam/iam.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/iam/detach_role_policy
> **spec:implements:** @kind:operation DetachRolePolicy
> **AWS Protocol:** query
> **HTTP:** POST /
> **@ref:** specs/aws/iam/docs/API_DetachRolePolicy.spec.md
...
| RoleName | Any  # complex shape | ✓ | The name (friendly name, not ARN) of the IAM role to detach the policy from. This parameter allows (through its regex pa |
...
```speclang
def detach_role_policy(store, request: dict) -> dict:
    ...
    return store.execute("DetachRolePolicy", request)
```
