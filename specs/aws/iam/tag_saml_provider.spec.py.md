---
id: "@specs/aws/iam/tag_saml_provider"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  - "@specs/aws/iam/plan"
  - "@specs/aws/iam/docs/API_TagSAMLProvider"
---

# TagSAMLProvider

> **spec:trace:** specs/aws/iam/iam.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/iam/tag_saml_provider
> **spec:implements:** @kind:operation TagSAMLProvider
> **AWS Protocol:** query
> **HTTP:** POST /
> **@ref:** specs/aws/iam/docs/API_TagSAMLProvider.spec.md
...
## Input Shape: TagSAMLProviderRequest

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| SAMLProviderArn | Any  # complex shape | ✓ | The ARN of the SAML identity provider in IAM to which you want to add tags. This parameter allows (through its regex pat |
| Tags | Any  # complex shape | ✓ | The list of tags that you want to attach to the SAML identity provider in IAM. Each tag consists of a key name and an as |
...
```speclang
def tag_saml_provider(store, request: dict) -> dict:
    """Adds one or more tags to a Security Assertion Markup Language (SAML) identity provider. For more information about these providers, see About SAML 2.0-based federation . If a tag with the same key nam"""
