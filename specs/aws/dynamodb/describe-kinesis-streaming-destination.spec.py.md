---
id: "@specs/aws/dynamodb/describe-kinesis-streaming-destination"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
tags: [aws, dynamodb, kinesis, streaming, describe-kinesis-streaming-destination]
short: "DescribeKinesisStreamingDestination — list Kinesis Data Streams destinations for a table"
---
...
Returns information about the status of Kinesis streaming destinations for a DynamoDB table. When enabled, DynamoDB streams item-level changes to a Kinesis data stream for real-time processing.

**Required:** `TableName`
**Input shape:** `DescribeKinesisStreamingDestinationInput`
**Output shape:** `DescribeKinesisStreamingDestinationOutput`
...
def describe_kinesis_streaming_destination(
    ...
    @kind:operation DescribeKinesisStreamingDestination
