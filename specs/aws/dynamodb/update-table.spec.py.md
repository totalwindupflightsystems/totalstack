---
id: "@specs/aws/dynamodb/update-table"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
short: "UpdateTable — Modifies provisioned throughput, GSIs, or Streams settings"
---
...
Modifies the provisioned throughput settings, global secondary indexes, or DynamoDB Streams settings for a given table. You can only perform one of the following operations at once: modify the provisioned throughput settings of the table, remove a global secondary index from the table, or create a new global secondary index on the table. `UpdateTable` is an asynchronous operation; while it's executing, the table status changes from `ACTIVE` to `UPDATING`.
