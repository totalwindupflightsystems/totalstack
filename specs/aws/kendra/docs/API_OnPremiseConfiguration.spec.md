---
id: "@specs/aws/kendra/docs/API_OnPremiseConfiguration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS OnPremiseConfiguration"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_OnPremiseConfiguration
> **target_lang:** meta — documentation tier. ALL sections preserved.



# OnPremiseConfiguration
<a name="API_OnPremiseConfiguration"></a>

Provides the configuration information to connect to GitHub Enterprise Server (on premises).

## Contents
<a name="API_OnPremiseConfiguration_Contents"></a>
...
## See Also
<a name="API_OnPremiseConfiguration_SeeAlso"></a>
