---
id: "@specs/aws/kendra/docs/API_ClearQuerySuggestions"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS ClearQuerySuggestions"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_ClearQuerySuggestions
> **target_lang:** meta — documentation tier. ALL sections preserved.



# ClearQuerySuggestions
<a name="API_ClearQuerySuggestions"></a>
...
## Request Syntax
<a name="API_ClearQuerySuggestions_RequestSyntax"></a>
...
## Request Parameters
<a name="API_ClearQuerySuggestions_RequestParameters"></a>
...
## Response Elements
<a name="API_ClearQuerySuggestions_ResponseElements"></a>

If the action is successful, the service sends back an HTTP 200 response with an empty HTTP body.

## Errors
<a name="API_ClearQuerySuggestions_Errors"></a>
...
## See Also
<a name="API_ClearQuerySuggestions_SeeAlso"></a>
