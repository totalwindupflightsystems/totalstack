---
id: "@specs/aws/kendra/docs/API_SalesforceStandardObjectAttachmentConfiguration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS SalesforceStandardObjectAttachmentConfiguration"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_SalesforceStandardObjectAttachmentConfiguration
> **target_lang:** meta — documentation tier. ALL sections preserved.



# SalesforceStandardObjectAttachmentConfiguration
<a name="API_SalesforceStandardObjectAttachmentConfiguration"></a>

Provides the configuration information for processing attachments to Salesforce standard objects.

## Contents
<a name="API_SalesforceStandardObjectAttachmentConfiguration_Contents"></a>
...
## See Also
<a name="API_SalesforceStandardObjectAttachmentConfiguration_SeeAlso"></a>
