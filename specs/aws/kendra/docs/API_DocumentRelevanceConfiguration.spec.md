---
id: "@specs/aws/kendra/docs/API_DocumentRelevanceConfiguration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DocumentRelevanceConfiguration"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_DocumentRelevanceConfiguration
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DocumentRelevanceConfiguration
<a name="API_DocumentRelevanceConfiguration"></a>

Overrides the document relevance properties of a custom index field.

## Contents
<a name="API_DocumentRelevanceConfiguration_Contents"></a>
...
## See Also
<a name="API_DocumentRelevanceConfiguration_SeeAlso"></a>
