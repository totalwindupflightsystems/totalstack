---
id: "@specs/aws/kendra/docs/API_DataSourceGroup"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DataSourceGroup"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_DataSourceGroup
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DataSourceGroup
<a name="API_DataSourceGroup"></a>

Data source information for user context filtering.

## Contents
<a name="API_DataSourceGroup_Contents"></a>
...
## See Also
<a name="API_DataSourceGroup_SeeAlso"></a>
