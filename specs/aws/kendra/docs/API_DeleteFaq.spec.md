---
id: "@specs/aws/kendra/docs/API_DeleteFaq"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DeleteFaq"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_DeleteFaq
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DeleteFaq
<a name="API_DeleteFaq"></a>

Removes a FAQ from an index.

## Request Syntax
<a name="API_DeleteFaq_RequestSyntax"></a>
...
## Request Parameters
<a name="API_DeleteFaq_RequestParameters"></a>
...
## Response Elements
<a name="API_DeleteFaq_ResponseElements"></a>

If the action is successful, the service sends back an HTTP 200 response with an empty HTTP body.

## Errors
<a name="API_DeleteFaq_Errors"></a>
...
## See Also
<a name="API_DeleteFaq_SeeAlso"></a>
