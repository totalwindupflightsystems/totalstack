---
id: "@specs/aws/kendra/docs/API_SaaSConfiguration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS SaaSConfiguration"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_SaaSConfiguration
> **target_lang:** meta — documentation tier. ALL sections preserved.



# SaaSConfiguration
<a name="API_SaaSConfiguration"></a>

Provides the configuration information to connect to GitHub Enterprise Cloud (SaaS).

## Contents
<a name="API_SaaSConfiguration_Contents"></a>
...
## See Also
<a name="API_SaaSConfiguration_SeeAlso"></a>
