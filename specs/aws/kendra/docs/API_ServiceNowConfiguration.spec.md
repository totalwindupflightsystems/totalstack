---
id: "@specs/aws/kendra/docs/API_ServiceNowConfiguration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS ServiceNowConfiguration"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_ServiceNowConfiguration
> **target_lang:** meta — documentation tier. ALL sections preserved.



# ServiceNowConfiguration
<a name="API_ServiceNowConfiguration"></a>

Provides the configuration information to connect to ServiceNow as your data source.

## Contents
<a name="API_ServiceNowConfiguration_Contents"></a>
...
## See Also
<a name="API_ServiceNowConfiguration_SeeAlso"></a>
