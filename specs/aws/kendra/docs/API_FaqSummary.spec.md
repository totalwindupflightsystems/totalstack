---
id: "@specs/aws/kendra/docs/API_FaqSummary"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS FaqSummary"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_FaqSummary
> **target_lang:** meta — documentation tier. ALL sections preserved.



# FaqSummary
<a name="API_FaqSummary"></a>

Summary information for frequently asked questions and answers included in an index.

## Contents
<a name="API_FaqSummary_Contents"></a>
...
## See Also
<a name="API_FaqSummary_SeeAlso"></a>
