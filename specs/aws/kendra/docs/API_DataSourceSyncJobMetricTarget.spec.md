---
id: "@specs/aws/kendra/docs/API_DataSourceSyncJobMetricTarget"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DataSourceSyncJobMetricTarget"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_DataSourceSyncJobMetricTarget
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DataSourceSyncJobMetricTarget
<a name="API_DataSourceSyncJobMetricTarget"></a>

Maps a particular data source sync job to a particular data source.

## Contents
<a name="API_DataSourceSyncJobMetricTarget_Contents"></a>
...
## See Also
<a name="API_DataSourceSyncJobMetricTarget_SeeAlso"></a>
