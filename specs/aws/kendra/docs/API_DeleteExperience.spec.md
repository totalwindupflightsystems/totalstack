---
id: "@specs/aws/kendra/docs/API_DeleteExperience"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DeleteExperience"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kendra/docs/API_DeleteExperience
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DeleteExperience
<a name="API_DeleteExperience"></a>
...
## Request Syntax
<a name="API_DeleteExperience_RequestSyntax"></a>
...
## Request Parameters
<a name="API_DeleteExperience_RequestParameters"></a>
...
## Response Elements
<a name="API_DeleteExperience_ResponseElements"></a>

If the action is successful, the service sends back an HTTP 200 response with an empty HTTP body.

## Errors
<a name="API_DeleteExperience_Errors"></a>
...
## See Also
<a name="API_DeleteExperience_SeeAlso"></a>
