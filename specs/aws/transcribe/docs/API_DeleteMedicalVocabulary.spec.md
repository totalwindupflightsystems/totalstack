---
id: "@specs/aws/transcribe/docs/API_DeleteMedicalVocabulary"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DeleteMedicalVocabulary"
status: active
depends_on:
...
> **spec:id:** @specs/aws/transcribe/docs/API_DeleteMedicalVocabulary
> **target_lang:** meta — documentation tier. ALL sections preserved.



# DeleteMedicalVocabulary
<a name="API_DeleteMedicalVocabulary"></a>
...
## Request Syntax
<a name="API_DeleteMedicalVocabulary_RequestSyntax"></a>
...
## Request Parameters
<a name="API_DeleteMedicalVocabulary_RequestParameters"></a>
...
## Response Elements
<a name="API_DeleteMedicalVocabulary_ResponseElements"></a>

If the action is successful, the service sends back an HTTP 200 response with an empty HTTP body.

## Errors
<a name="API_DeleteMedicalVocabulary_Errors"></a>
...
## See Also
<a name="API_DeleteMedicalVocabulary_SeeAlso"></a>

For more information about using this API in one of the language-specific AWS SDKs, see the following:
+  [AWS Command Line Interface V2](https://docs.aws.amazon.com/goto/cli2/transcribe-2017-10-26/DeleteMedicalVocabulary) 
+  [AWS SDK for .NET V4](https://docs.aws.amazon.com/goto/DotNetSDKV4/transcribe-2017-10-26/DeleteMedicalVocabulary) 
+  [AWS SDK for C\+\+](https://docs.aws.amazon.com/goto/SdkForCpp/transcribe-2017-10-26/DeleteMedicalVocabulary) 
+  [AWS SDK for Go v2](https://docs.aws.amazon.com/goto/SdkForGoV2/transcribe-2017-10-26/DeleteMedicalVocabulary) 
+  [AWS SDK for Java V2](https://docs.aws.amazon.com/goto/SdkForJavaV2/transcribe-2017-10-26/DeleteMedicalVocabulary) 
+  [AWS SDK for JavaScript V3](https://docs.aws.amazon.com/goto/SdkForJavaScriptV3/transcribe-2017-10-26/DeleteMedicalVocabulary) 
+  [AWS SDK for Kotlin](https://docs.aws.amazon.com/goto/SdkForKotlin/transcribe-2017-10-26/DeleteMedicalVocabulary) 
