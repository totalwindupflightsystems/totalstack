---
id: "@specs/aws/rekognition/search_faces_by_image"
target_lang: py
version: 1.0.0
owned-by: codegen
status: active
...
|-------|------|----------|-------------|
| `CollectionId` | CollectionId | Yes | ID of the collection to search. |
| `FaceMatchThreshold` | Percent | No | (Optional) Specifies the minimum confidence in the face match to return. For example, don't return a |
