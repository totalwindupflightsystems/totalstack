---
id: "@specs/aws/datasync/docs/configure-agent-multinic"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Configuring your agent for multiple NICs"
status: active
depends_on:
...
> **spec:id:** @specs/aws/datasync/docs/configure-agent-multinic
