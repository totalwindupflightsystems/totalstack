---
id: "@specs/aws/network-firewall/docs/API_DeleteProxyConfiguration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS DeleteProxyConfiguration"
status: active
depends_on:
...
> **spec:id:** @specs/aws/network-firewall/docs/API_DeleteProxyConfiguration
