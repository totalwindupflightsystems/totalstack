---
id: "@specs/aws/lightsail/get_export_snapshot_records"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  ...
  - "@specs/aws/lightsail/docs/API_GetExportSnapshotRecords"
---

# GetExportSnapshotRecords

> **spec:trace:** specs/aws/lightsail/lightsail.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/lightsail/get_export_snapshot_records
> **spec:implements:** @kind:operation GetExportSnapshotRecords
> **AWS Protocol:** json
> **HTTP:** POST /
> **@ref:** specs/aws/lightsail/docs/API_GetExportSnapshotRecords.spec.md
...
|-----------|------|----------|-------------|
| pageToken | Any  # complex shape |  | The token to advance to the next page of results from your request. To get a page token, perform an initial GetExportSna |

## Output Shape: GetExportSnapshotRecordsResult

- **exportSnapshotRecords** (list[Any  # complex shape]): A list of objects describing the export snapshot records.
