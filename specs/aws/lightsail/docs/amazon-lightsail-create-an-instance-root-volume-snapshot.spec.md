---
id: "@specs/aws/lightsail/docs/amazon-lightsail-create-an-instance-root-volume-snapshot"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Create a root volume snapshot"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-create-an-instance-root-volume-snapshot
