---
id: "@specs/aws/lightsail/docs/amazon-lightsail-changing-preferred-maintenance-and-backup-windows"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Maintenance and backup windows"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-changing-preferred-maintenance-and-backup-windows
...
+ **Install the AWS CLI** — For more information, see [Installing the AWS CLII](http://docs.aws.amazon.com/cli/latest/userguide/installing.html).
+ **Configure the AWS CLI** — For more information, see [Configuring the AWS CLI](https://lightsail.aws.amazon.com/ls/docs/en/articles/lightsail-how-to-set-up-and-configure-aws-cli).
...
+ [Configure the public mode for your database](amazon-lightsail-configuring-database-public-mode.md)
