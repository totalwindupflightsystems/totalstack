---
id: "@specs/aws/lightsail/docs/amazon-lightsail-bucket-management-policies"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Manage buckets with IAM"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-bucket-management-policies
