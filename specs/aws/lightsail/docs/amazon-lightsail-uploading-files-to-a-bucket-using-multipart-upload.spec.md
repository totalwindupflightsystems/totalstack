---
id: "@specs/aws/lightsail/docs/amazon-lightsail-uploading-files-to-a-bucket-using-multipart-upload"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Multipart upload"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-uploading-files-to-a-bucket-using-multipart-upload
