---
id: "@specs/aws/lightsail/docs/amazon-lightsail-using-bucket-access-logs"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Use access logs"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-using-bucket-access-logs
