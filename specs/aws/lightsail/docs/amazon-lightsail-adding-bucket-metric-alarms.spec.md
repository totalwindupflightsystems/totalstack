---
id: "@specs/aws/lightsail/docs/amazon-lightsail-adding-bucket-metric-alarms"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Create alarms"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-adding-bucket-metric-alarms
