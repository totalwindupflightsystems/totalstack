---
id: "@specs/aws/lightsail/docs/amazon-lightsail-connecting-to-postgres-database-using-ssl"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Connect to PostgreSQL using SSL"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-connecting-to-postgres-database-using-ssl
...
![Postgres database connection status.](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-postgres-ssl-connection.png)