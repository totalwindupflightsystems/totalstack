---
id: "@specs/aws/lightsail/docs/lightsail-how-to-create-larger-instance-from-snapshot-using-aws-cli"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Create a larger resource from a snapshot using the AWS CLI"
status: active
depends_on:
  - "@specs/aws/lightsail/meta"
---

# Create a larger resource from a snapshot using the AWS CLI

> **source:** AWS Documentation
> **spec:id:** @specs/aws/lightsail/docs/lightsail-how-to-create-larger-instance-from-snapshot-using-aws-cli
