---
id: "@specs/aws/lightsail/docs/amazon-lightsail-connecting-to-your-mysql-database"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Connect to MySQL"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-connecting-to-your-mysql-database
...
**Note**  
For more information about connecting to a PostgreSQL database, see [Connect to your PostgreSQL database](amazon-lightsail-connecting-to-your-postgres-database.md).
...
![Database endpoint and port in the Lightsail console](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-database-endpoint-and-port.png)
...
![MySQL Workbench connection configuration](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-workbench-connection-manager.png)
...
![MySQL Workbench successful connection test](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-workbench-successful-connection.png)
...
![MySQL Workbench workspace](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-workbench-workspace.png)
