---
id: "@specs/aws/lightsail/docs/amazon-lightsail-bucket-access-log-format"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Access log format"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-bucket-access-log-format
