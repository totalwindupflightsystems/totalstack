---
id: "@specs/aws/lightsail/docs/amazon-lightsail-connecting-to-your-postgres-database"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Connect to PostgreSQL"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-connecting-to-your-postgres-database
...
**Note**  
For more information about connecting to a MySQL database, see [Connect to your MySQL database](amazon-lightsail-connecting-to-your-mysql-database.md).
...
![Database endpoint and port in the Lightsail console](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-postgres-database-endpoint-and-port.png)
...
1.   
![pgAdmin server configuration](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-pgadmin-create-server.png)
...
![pgAdmin server configuration form](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-pgadmin-create-server-form-connection-tab.png)
...
![pgAdmin workspace](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-pgadmin-connected.png)
