---
id: "@specs/aws/lightsail/docs/add-alternate-domain-names-to-tls-ssl-certificate-https"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Add alternate domains"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/add-alternate-domain-names-to-tls-ssl-certificate-https
