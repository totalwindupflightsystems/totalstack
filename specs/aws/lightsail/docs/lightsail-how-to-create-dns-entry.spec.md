---
id: "@specs/aws/lightsail/docs/lightsail-how-to-create-dns-entry"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Create a DNS zone"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/lightsail-how-to-create-dns-entry
