---
id: "@specs/aws/lightsail/docs/amazon-lightsail-register-new-domain"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Register a domain"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-register-new-domain
