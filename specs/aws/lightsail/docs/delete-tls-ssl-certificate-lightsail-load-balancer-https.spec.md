---
id: "@specs/aws/lightsail/docs/delete-tls-ssl-certificate-lightsail-load-balancer-https"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Remove SSL/TLS certificate"
status: active
depends_on:
  - "@specs/aws/lightsail/meta"
---

# Remove SSL/TLS certificate

> **source:** AWS Documentation
> **spec:id:** @specs/aws/lightsail/docs/delete-tls-ssl-certificate-lightsail-load-balancer-https
