---
id: "@specs/aws/lightsail/docs/amazon-lightsail-adding-distribution-default-domain-to-container-service"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Add distribution domain to container service"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-adding-distribution-default-domain-to-container-service
