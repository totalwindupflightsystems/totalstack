---
id: "@specs/aws/lightsail/docs/amazon-lightsail-enabling-mysql-general-and-slow-query-logs"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS MySQL query logs"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-enabling-mysql-general-and-slow-query-logs
...
If you haven't done so already, install and configure the AWS CLI. For more information, see [Configure the AWS Command Line Interface to work with Amazon Lightsail](lightsail-how-to-set-up-and-configure-aws-cli.md).
