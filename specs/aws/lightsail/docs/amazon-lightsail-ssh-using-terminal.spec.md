---
id: "@specs/aws/lightsail/docs/amazon-lightsail-ssh-using-terminal"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Connect with SSH command"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-ssh-using-terminal
