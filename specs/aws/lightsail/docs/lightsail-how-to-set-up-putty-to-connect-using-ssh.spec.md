---
id: "@specs/aws/lightsail/docs/lightsail-how-to-set-up-putty-to-connect-using-ssh"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Set up PuTTY"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/lightsail-how-to-set-up-putty-to-connect-using-ssh
