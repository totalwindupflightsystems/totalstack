---
id: "@specs/aws/lightsail/docs/prepare-windows-based-instance-and-create-snapshot"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Windows snapshots and sysprep"
status: active
depends_on:
  - "@specs/aws/lightsail/meta"
---

# Windows snapshots and sysprep

> **source:** AWS Documentation
> **spec:id:** @specs/aws/lightsail/docs/prepare-windows-based-instance-and-create-snapshot
