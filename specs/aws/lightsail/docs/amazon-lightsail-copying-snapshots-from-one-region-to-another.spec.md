---
id: "@specs/aws/lightsail/docs/amazon-lightsail-copying-snapshots-from-one-region-to-another"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Copy snapshots across Regions"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-copying-snapshots-from-one-region-to-another
