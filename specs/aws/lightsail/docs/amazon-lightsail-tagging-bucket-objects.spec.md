---
id: "@specs/aws/lightsail/docs/amazon-lightsail-tagging-bucket-objects"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Tag objects"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-tagging-bucket-objects
