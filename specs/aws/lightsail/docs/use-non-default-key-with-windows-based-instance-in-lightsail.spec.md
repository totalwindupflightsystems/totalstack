---
id: "@specs/aws/lightsail/docs/use-non-default-key-with-windows-based-instance-in-lightsail"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Change the Administrator password"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/use-non-default-key-with-windows-based-instance-in-lightsail
