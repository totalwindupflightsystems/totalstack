---
id: "@specs/aws/lightsail/docs/enable-session-stickiness-persistence-or-change-cookie-duration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Session persistence"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/enable-session-stickiness-persistence-or-change-cookie-duration
