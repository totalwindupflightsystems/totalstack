---
id: "@specs/aws/lightsail/docs/amazon-lightsail-distribution-request-and-response"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Request and response behaviors"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-distribution-request-and-response
