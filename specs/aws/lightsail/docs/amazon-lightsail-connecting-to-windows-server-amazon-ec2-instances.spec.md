---
id: "@specs/aws/lightsail/docs/amazon-lightsail-connecting-to-windows-server-amazon-ec2-instances"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Connect to Windows EC2 instances"
status: active
depends_on:
  - "@specs/aws/lightsail/meta"
---

# Connect to Windows EC2 instances

> **source:** AWS Documentation
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-connecting-to-windows-server-amazon-ec2-instances
