---
id: "@specs/aws/lightsail/docs/create-and-attach-additional-block-storage-disks-windows"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Attach disks to Windows instances"
status: active
depends_on:
  - "@specs/aws/lightsail/meta"
---

# Attach disks to Windows instances

> **source:** AWS Documentation
> **spec:id:** @specs/aws/lightsail/docs/create-and-attach-additional-block-storage-disks-windows
