---
id: "@specs/aws/lightsail/docs/create-new-block-storage-disk-from-snapshot"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Create disk from snapshot"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/create-new-block-storage-disk-from-snapshot
