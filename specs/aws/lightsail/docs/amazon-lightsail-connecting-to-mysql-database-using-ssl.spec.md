---
id: "@specs/aws/lightsail/docs/amazon-lightsail-connecting-to-mysql-database-using-ssl"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Connect to MySQL using SSL"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-connecting-to-mysql-database-using-ssl
...
For more information about the CA certificates for your managed database, supported AWS Regions, and how you can download intermediate certificates for your applications, see [Download an SSL certificate for your managed database](amazon-lightsail-download-ssl-certificate-for-managed-database.md).
...
+ Download the appropriate certificate for your database. For information, see [Download an SSL certificate for your managed database](amazon-lightsail-download-ssl-certificate-for-managed-database.md).
...
![MySQL database connection.](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-ssl-connection.png)
...
![MySQL database connection status.](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-mysql-ssl-status.png)