---
id: "@specs/aws/lightsail/docs/amazon-lightsail-copying-moving-bucket-objects"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Copy and move objects"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-copying-moving-bucket-objects
