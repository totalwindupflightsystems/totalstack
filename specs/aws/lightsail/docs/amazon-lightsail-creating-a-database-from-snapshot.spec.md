---
id: "@specs/aws/lightsail/docs/amazon-lightsail-creating-a-database-from-snapshot"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Create database from snapshot"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-creating-a-database-from-snapshot
