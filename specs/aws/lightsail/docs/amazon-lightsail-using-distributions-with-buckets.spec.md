---
id: "@specs/aws/lightsail/docs/amazon-lightsail-using-distributions-with-buckets"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Use buckets with distributions"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-using-distributions-with-buckets
...
+ Create and configure a WordPress instance in Lightsail, and get the password to sign in to the administration dashboard. For more information, see [Launch and configure a WordPress instance in Amazon Lightsail](amazon-lightsail-launch-and-configure-wordpress.md).
