---
id: "@specs/aws/lightsail/docs/amazon-lightsail-downloading-bucket-objects"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Download objects"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-downloading-bucket-objects
