---
id: "@specs/aws/lightsail/docs/amazon-lightsail-creating-a-database-from-point-in-time-backup"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Restore database"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-creating-a-database-from-point-in-time-backup
...
![Creating a database from a point-in-time backup](http://docs.aws.amazon.com/lightsail/latest/userguide/images/amazon-lightsail-create-new-database-from-emergency-restore.png)
