---
id: "@specs/aws/lightsail/docs/amazon-lightsail-remove-ssh-key-on-instance"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Manage instance SSH keys"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-remove-ssh-key-on-instance
