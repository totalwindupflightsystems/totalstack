---
id: "@specs/aws/lightsail/docs/verify-tls-ssl-certificate-using-dns-cname-https"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Verify SSL/TLS certificates"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/verify-tls-ssl-certificate-using-dns-cname-https
