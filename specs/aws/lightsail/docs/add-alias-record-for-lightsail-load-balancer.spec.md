---
id: "@specs/aws/lightsail/docs/add-alias-record-for-lightsail-load-balancer"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Point domain to a load balancer"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/add-alias-record-for-lightsail-load-balancer
