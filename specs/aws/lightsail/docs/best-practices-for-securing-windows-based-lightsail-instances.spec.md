---
id: "@specs/aws/lightsail/docs/best-practices-for-securing-windows-based-lightsail-instances"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Windows security best practices"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/best-practices-for-securing-windows-based-lightsail-instances
