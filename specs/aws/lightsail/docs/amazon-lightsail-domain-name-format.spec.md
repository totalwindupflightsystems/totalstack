---
id: "@specs/aws/lightsail/docs/amazon-lightsail-domain-name-format"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Format domain names"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-domain-name-format
...
+ [Use an asterisk (\*) in the names of DNS zones and records](#using-asterisk)
...
**DNS zones**
+ You can't include an asterisk (\*) in the leftmost label in a domain name. For example, you can’t use **\*.example.com**.
