---
id: "@specs/aws/lightsail/docs/amazon-lightsail-using-service-linked-roles"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Use service-linked roles"
status: active
depends_on:
...
> **spec:id:** @specs/aws/lightsail/docs/amazon-lightsail-using-service-linked-roles
...
**Important**  
You must configure IAM permissions to allow Amazon Lightsail to create the service-linked role. To do this, complete the steps in the preceding [Service-Linked Role Permissions](#service-linked-role-permissions) section.
...
Amazon Lightsail supports using service-linked roles in all of the regions where the service is available. For more information about the regions that Lightsail is available in, see [Amazon Lightsail Regions](https://docs.aws.amazon.com/general/latest/gr/rande.html#lightsail_region).