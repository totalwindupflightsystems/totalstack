---
id: "@specs/aws/lightsail/start_instance"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  ...
  - "@specs/aws/lightsail/docs/API_StartInstance"
---

# StartInstance

> **spec:trace:** specs/aws/lightsail/lightsail.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/lightsail/start_instance
> **spec:implements:** @kind:operation StartInstance
> **AWS Protocol:** json
> **HTTP:** POST /
> **@ref:** specs/aws/lightsail/docs/API_StartInstance.spec.md
...
|-----------|------|----------|-------------|
| instanceName | Any  # complex shape | ✓ | The name of the instance (a virtual private server) to start. |
