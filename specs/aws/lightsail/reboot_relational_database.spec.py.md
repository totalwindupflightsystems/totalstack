---
id: "@specs/aws/lightsail/reboot_relational_database"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  ...
  - "@specs/aws/lightsail/docs/API_RebootRelationalDatabase"
---

# RebootRelationalDatabase

> **spec:trace:** specs/aws/lightsail/lightsail.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/lightsail/reboot_relational_database
> **spec:implements:** @kind:operation RebootRelationalDatabase
> **AWS Protocol:** json
> **HTTP:** POST /
> **@ref:** specs/aws/lightsail/docs/API_RebootRelationalDatabase.spec.md
...
|-----------|------|----------|-------------|
| relationalDatabaseName | Any  # complex shape | ✓ | The name of your database to reboot. |
