---
id: "@specs/aws/ec2/describe_verified_access_instances"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  - "@specs/aws/ec2/plan"
  - "@specs/aws/ec2/docs/API_DescribeVerifiedAccessInstances"
---

# DescribeVerifiedAccessInstances

> **spec:trace:** specs/aws/ec2/ec2.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/ec2/describe_verified_access_instances
> **spec:implements:** @kind:operation DescribeVerifiedAccessInstances
> **AWS Protocol:** ec2
> **HTTP:** POST /
> **@ref:** specs/aws/ec2/docs/API_DescribeVerifiedAccessInstances.spec.md
...
- **VerifiedAccessInstances** (list[Any  # complex shape]): Details about the Verified Access instances.

## Implementation

```speclang
def describe_verified_access_instances(store, request: dict) -> dict:
    """Describes the specified Amazon Web Services Verified Access instances."""
