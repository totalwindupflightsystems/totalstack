---
id: "@specs/aws/ec2/associate_transit_gateway_multicast_domain"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  - "@specs/aws/ec2/plan"
  - "@specs/aws/ec2/docs/API_AssociateTransitGatewayMulticastDomain"
---

# AssociateTransitGatewayMulticastDomain

> **spec:trace:** specs/aws/ec2/ec2.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/ec2/associate_transit_gateway_multicast_domain
> **spec:implements:** @kind:operation AssociateTransitGatewayMulticastDomain
> **AWS Protocol:** ec2
> **HTTP:** POST /
> **@ref:** specs/aws/ec2/docs/API_AssociateTransitGatewayMulticastDomain.spec.md
...
| SubnetIds | list[Any  # complex shape] | ✓ | The IDs of the subnets to associate with the transit gateway multicast domain. |
| TransitGatewayAttachmentId | Any  # complex shape | ✓ | The ID of the transit gateway attachment to associate with the transit gateway multicast domain. |
...
- **Associations** (Any  # complex shape): Information about the transit gateway multicast domain associations.

## Implementation

```speclang
def associate_transit_gateway_multicast_domain(store, request: dict) -> dict:
    """Associates the specified subnets and transit gateway attachments with the specified transit gateway multicast domain. The transit gateway attachment must be in the available state before you can add a"""
    ...
    return store.execute("AssociateTransitGatewayMulticastDomain", request)
```
