---
id: "@specs/aws/ec2/detach_verified_access_trust_provider"
version: 1.0.0
target_lang: py
owned-by: codegen
model_pool: code-gen
...
depends_on:
  - "@specs/aws/ec2/plan"
  - "@specs/aws/ec2/docs/API_DetachVerifiedAccessTrustProvider"
---

# DetachVerifiedAccessTrustProvider

> **spec:trace:** specs/aws/ec2/ec2.spec.plan.md#operation-inventory
> **spec:id:** @specs/aws/ec2/detach_verified_access_trust_provider
> **spec:implements:** @kind:operation DetachVerifiedAccessTrustProvider
> **AWS Protocol:** ec2
> **HTTP:** POST /
> **@ref:** specs/aws/ec2/docs/API_DetachVerifiedAccessTrustProvider.spec.md
...
```speclang
def detach_verified_access_trust_provider(store, request: dict) -> dict:
    """Detaches the specified Amazon Web Services Verified Access trust provider from the specified Amazon Web Services Verified Access instance."""
    ...
    return store.execute("DetachVerifiedAccessTrustProvider", request)
```
