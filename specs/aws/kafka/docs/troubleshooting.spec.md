---
id: "@specs/aws/kafka/docs/troubleshooting"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Troubleshoot Amazon MSK cluster"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kafka/docs/troubleshooting
...
The following information can help you troubleshoot problems that you might have with your Amazon MSK cluster. You can also post your issue to [AWS re:Post](https://repost.aws/). For troubleshooting Amazon MSK Replicator, see [Troubleshoot Amazon MSK Replicator](msk-replicator-troubleshooting.md).
