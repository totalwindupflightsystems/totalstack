---
id: "@specs/aws/kafka/docs/mkc-S3sink-connector-example"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Set up Amazon S3 sink connector"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kafka/docs/mkc-S3sink-connector-example
