---
id: "@specs/aws/kafka/docs/msk-connect-service-execution-role"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Understand service execution role"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kafka/docs/msk-connect-service-execution-role
