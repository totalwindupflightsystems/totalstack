---
id: "@specs/aws/kafka/docs/create-topic"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
...
> **spec:id:** @specs/aws/kafka/docs/create-topic
...
1. **Set up authentication for your MSK cluster.**
   ...
   1. Using the following commands, navigate to the `$KAFKA_ROOT/libs` directory and download the associated Amazon MSK IAM JAR that you found in the previous step. Make sure to replace {{{LATEST VERSION}}} with the actual version number you're downloading.
