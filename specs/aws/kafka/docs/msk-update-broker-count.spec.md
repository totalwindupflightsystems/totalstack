---
id: "@specs/aws/kafka/docs/msk-update-broker-count"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Expand a cluster"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kafka/docs/msk-update-broker-count
...
1. From the **Actions** dropdown, choose **Edit number of brokers**.
