---
id: "@specs/aws/kafka/docs/msk-reboot-broker"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Reboot a broker for an Amazon MSK cluster"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kafka/docs/msk-reboot-broker
...
This process describes how to reboot a broker for a Amazon MSK cluster using the AWS Management Console.
...
The `reboot-broker` operation only supports rebooting one broker at a time.
   ...
   If you don't have the ARN for your cluster, you can find it by listing all clusters. For more information, see [List Amazon MSK clusters](msk-list-clusters.md).
