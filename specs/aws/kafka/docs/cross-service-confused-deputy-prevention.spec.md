---
id: "@specs/aws/kafka/docs/cross-service-confused-deputy-prevention"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Prevent cross-service confused deputy problem"
status: active
depends_on:
...
> **spec:id:** @specs/aws/kafka/docs/cross-service-confused-deputy-prevention
