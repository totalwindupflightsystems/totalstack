---
id: "@specs/aws/appconfig/docs/working-with-appconfig-extensions-creating-custom-lambda"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Step 1: Create a Lambda function for a custom AWS AppConfig extension"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/working-with-appconfig-extensions-creating-custom-lambda
