---
id: "@specs/aws/appconfig/docs/appconfig-creating-configuration-and-profile-S3-source"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Understanding configurations stored in Amazon S3"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/appconfig-creating-configuration-and-profile-S3-source
