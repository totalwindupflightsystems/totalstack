---
id: "@specs/aws/appconfig/docs/working-with-appconfig-extensions-creating-custom-association"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Step 4: Create an extension association for a custom AWS AppConfig extension"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/working-with-appconfig-extensions-creating-custom-association
