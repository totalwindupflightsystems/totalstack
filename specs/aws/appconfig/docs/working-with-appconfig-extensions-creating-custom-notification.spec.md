---
id: "@specs/aws/appconfig/docs/working-with-appconfig-extensions-creating-custom-notification"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Customizing AWS authored notification extensions"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/working-with-appconfig-extensions-creating-custom-notification
