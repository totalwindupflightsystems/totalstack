---
id: "@specs/aws/appconfig/docs/appconfig-integration-codepipeline"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Deploying with CodePipeline"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/appconfig-integration-codepipeline
