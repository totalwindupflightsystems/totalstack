---
id: "@specs/aws/appconfig/docs/working-with-appconfig-extensions-about-predefined-notification-eventbridge"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Using the AWS AppConfig deployment events to Amazon EventBridge extension"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/working-with-appconfig-extensions-about-predefined-notification-eventbridge
