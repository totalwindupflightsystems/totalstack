---
id: "@specs/aws/appconfig/docs/appconfig-code-samples-using-API-read-configuration"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Using the GetLatestConfiguration API action to read a freeform configuration profile"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/appconfig-code-samples-using-API-read-configuration
