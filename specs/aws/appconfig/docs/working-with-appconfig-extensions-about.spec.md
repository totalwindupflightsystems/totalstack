---
id: "@specs/aws/appconfig/docs/working-with-appconfig-extensions-about"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Understanding AWS AppConfig extensions"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/working-with-appconfig-extensions-about
...
**AT\_\* action points**: Extension actions configured on `AT_*` action points are invoked synchronously and in parallel to an AWS AppConfig workflow. If an extension experiences an error during an `AT_*` action point, the service stops the workflow and rolls back the deployment.
+ `AT_DEPLOYMENT_TICK`
