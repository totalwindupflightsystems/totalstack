---
id: "@specs/aws/appconfig/docs/appconfig-creating-free-form-configuration-and-profile-create-commandline"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Creating an AWS AppConfig freeform configuration profile (command line)"
status: active
depends_on:
...
> **spec:id:** @specs/aws/appconfig/docs/appconfig-creating-free-form-configuration-and-profile-create-commandline
