---
id: "@specs/aws/storagegateway/docs/Welcome"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Welcome"
...
> **spec:id:** @specs/aws/storagegateway/docs/Welcome
...
+  [Storage Gateway endpoints and quotas](https://docs.aws.amazon.com/general/latest/gr/sg.html): Provides a list of each AWS Region and the endpoints available for use with Storage Gateway.
