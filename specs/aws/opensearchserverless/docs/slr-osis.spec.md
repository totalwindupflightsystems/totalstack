---
id: "@specs/aws/opensearchserverless/docs/slr-osis"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Pipeline creation role"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/slr-osis
...
1. Choose **Roles** and search for the **AWSServiceRoleForAmazonOpenSearchIngestionService** or **AWSServiceRoleForOpensearchIngestionSelfManagedVpce** role.
