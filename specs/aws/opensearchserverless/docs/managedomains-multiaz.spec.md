---
id: "@specs/aws/opensearchserverless/docs/managedomains-multiaz"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Configuring a multi-AZ domain"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/managedomains-multiaz
