---
id: "@specs/aws/opensearchserverless/docs/vpc-interface-endpoints"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Working with OpenSearch Service-managed VPC endpoints"
status: active
depends_on:
  - "@specs/aws/opensearchserverless/meta"
---

# Working with OpenSearch Service-managed VPC endpoints

> **source:** AWS Documentation
> **spec:id:** @specs/aws/opensearchserverless/docs/vpc-interface-endpoints
...
Before you set up an interface VPC endpoint for OpenSearch Service, review [Access an AWS service using an interface VPC endpoint](https://docs.aws.amazon.com/vpc/latest/privatelink/create-interface-endpoint.html) in the *AWS PrivateLink Guide*. 
