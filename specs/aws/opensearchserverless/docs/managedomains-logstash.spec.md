---
id: "@specs/aws/opensearchserverless/docs/managedomains-logstash"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Loading data with Logstash"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/managedomains-logstash
