---
id: "@specs/aws/opensearchserverless/docs/monitoring-pipeline-logs"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Monitoring pipeline logs"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/monitoring-pipeline-logs
