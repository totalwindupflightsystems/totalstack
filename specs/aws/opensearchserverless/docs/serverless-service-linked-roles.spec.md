---
id: "@specs/aws/opensearchserverless/docs/serverless-service-linked-roles"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Collection creation role"
status: active
depends_on:
  - "@specs/aws/opensearchserverless/meta"
---

# Collection creation role

> **source:** AWS Documentation
> **spec:id:** @specs/aws/opensearchserverless/docs/serverless-service-linked-roles
...
To delete the AWSServiceRoleForAmazonOpenSearchServerless, you must first [delete all OpenSearch Serverless collections](serverless-delete.md) in your AWS account.
