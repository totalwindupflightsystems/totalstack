---
id: "@specs/aws/opensearchserverless/docs/configuration-samples"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Using the AWS SDKs"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/configuration-samples
