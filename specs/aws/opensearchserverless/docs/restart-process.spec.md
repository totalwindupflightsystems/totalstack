---
id: "@specs/aws/opensearchserverless/docs/restart-process"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Restarting the OpenSearch process on a data node"
status: active
depends_on:
  - "@specs/aws/opensearchserverless/meta"
---

# Restarting the OpenSearch process on a data node

> **source:** AWS Documentation
> **spec:id:** @specs/aws/opensearchserverless/docs/restart-process
