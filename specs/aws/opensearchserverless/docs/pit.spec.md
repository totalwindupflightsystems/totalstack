---
id: "@specs/aws/opensearchserverless/docs/pit"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Point in time"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/pit
...
```
POST {{opensearch-domain}}/{{my-index}}/_search/point_in_time?keep_alive={{5m}}
```
