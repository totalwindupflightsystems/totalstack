---
id: "@specs/aws/opensearchserverless/docs/gsg-serverless"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Tutorial: Getting started with security (console)"
status: active
depends_on:
  - "@specs/aws/opensearchserverless/meta"
---

# Tutorial: Getting started with security (console)

> **source:** AWS Documentation
> **spec:id:** @specs/aws/opensearchserverless/docs/gsg-serverless
