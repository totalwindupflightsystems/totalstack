---
id: "@specs/aws/opensearchserverless/docs/osis-features-overview"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Pipeline features"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/osis-features-overview
...
Pipelines with persistent buffer enabled split the configured OCUs (pipeline units) between compute and buffer evenly using a 1:1 buffer-to-compute ratio, regardless of processor type.
