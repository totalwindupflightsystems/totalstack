---
id: "@specs/aws/opensearchserverless/docs/audit-logs"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Monitoring audit logs"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/audit-logs
...
**Topics**
+ [Limitations](#audit-logs-limitations)
+ [Enabling audit logs](#audit-log-enabling)
+ [Enable audit logging using the AWS CLI](#audit-log-enabling-cli)
+ [Enable audit logging using the configuration API](#audit-log-enabling-api)
+ [Audit log layers and categories](#audit-log-layers)
+ [Audit log settings](#audit-log-settings)
+ [Audit log example](#audit-log-example)
+ [Configuring audit logs using the REST API](#audit-log-rest-api)
...
| INDEX\_EVENT | A request performed an administrative operation on an index, such as creating one, setting an alias, or performing a force merge. The full list of indices:admin/ actions that this category includes are available in the [OpenSearch documentation](https://docs.opensearch.org/latest/security-plugin/access-control/permissions/). | No | Yes | 
