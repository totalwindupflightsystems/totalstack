---
id: "@specs/aws/opensearchserverless/docs/slr-aos"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS VPC domain and data source creation role"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/slr-aos
...
OpenSearch Service uses the service-linked role named **AWSServiceRoleForAmazonOpenSearchService**, which provides the minimum Amazon EC2 and Elastic Load Balancing permissions necessary for the role to enable [VPC access](cognito-auth.md) for a domain or a direct query data source.
