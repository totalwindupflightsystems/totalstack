---
id: "@specs/aws/opensearchserverless/docs/sns-events"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Tutorial: Sending SNS alerts for available updates"
status: active
depends_on:
  - "@specs/aws/opensearchserverless/meta"
---

# Tutorial: Sending SNS alerts for available updates

> **source:** AWS Documentation
> **spec:id:** @specs/aws/opensearchserverless/docs/sns-events
