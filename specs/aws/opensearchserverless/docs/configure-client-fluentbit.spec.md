---
id: "@specs/aws/opensearchserverless/docs/configure-client-fluentbit"
version: 1.0.0
target_lang: meta
owned-by: aws-docs
source: "AWS Fluent Bit"
status: active
depends_on:
...
> **spec:id:** @specs/aws/opensearchserverless/docs/configure-client-fluentbit
