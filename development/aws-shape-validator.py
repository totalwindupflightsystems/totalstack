...
def _call_handler(service: str, op_name: str, handler, store) -> dict:
    ...
    test_inputs = {
        ...
        # ── eks ───────────────────────────────────────────────────────────
        'CreateCluster': {'name': 'eks-test-cluster', 'roleArn': 'arn:aws:iam::123456789012:role/eks-role', 'resourcesVpcConfig': {'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}},
        'DescribeCluster': lambda store: (store.create_cluster('eks-desc', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'name': 'eks-desc'})[1],
        'ListClusters': {},
        'DeleteCluster': lambda store: (store.create_cluster('eks-del', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'name': 'eks-del'})[1],
        'UpdateClusterConfig': lambda store: (store.create_cluster('eks-upd-cfg', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'name': 'eks-upd-cfg', 'resourcesVpcConfig': {'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-999']}})[1],
        'UpdateClusterVersion': lambda store: (store.create_cluster('eks-upd-ver', version='1.27', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'name': 'eks-upd-ver', 'version': '1.28'})[1],
        'CreateNodegroup': lambda store: (store.create_cluster('eks-ng-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'clusterName': 'eks-ng-c', 'nodegroupName': 'test-ng', 'scalingConfig': {'minSize': 1, 'maxSize': 3, 'desiredSize': 2}, 'subnets': ['subnet-123'], 'nodeRole': 'arn:aws:iam::123456789012:role/node'})[1],
        'DescribeNodegroup': lambda store: (store.create_cluster('eks-dng-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_nodegroup('eks-dng-c', 'dng-ng', scalingConfig={'minSize': 1, 'maxSize': 3, 'desiredSize': 2}, subnets=['subnet-123'], nodeRole='arn:aws:iam::123456789012:role/node'), {'clusterName': 'eks-dng-c', 'nodegroupName': 'dng-ng'})[2],
        'ListNodegroups': {'clusterName': 'eks-test-cluster'},
        'DeleteNodegroup': lambda store: (store.create_cluster('eks-delng-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_nodegroup('eks-delng-c', 'del-ng', scalingConfig={'minSize': 1, 'maxSize': 3, 'desiredSize': 2}, subnets=['subnet-123'], nodeRole='arn:aws:iam::123456789012:role/node'), {'clusterName': 'eks-delng-c', 'nodegroupName': 'del-ng'})[2],
        'UpdateNodegroupConfig': lambda store: (store.create_cluster('eks-ungc-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_nodegroup('eks-ungc-c', 'ungc-ng', scalingConfig={'minSize': 1, 'maxSize': 3, 'desiredSize': 2}, subnets=['subnet-123'], nodeRole='arn:aws:iam::123456789012:role/node'), {'clusterName': 'eks-ungc-c', 'nodegroupName': 'ungc-ng', 'scalingConfig': {'minSize': 1, 'maxSize': 5, 'desiredSize': 3}})[2],
        'UpdateNodegroupVersion': lambda store: (store.create_cluster('eks-unv-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_nodegroup('eks-unv-c', 'unv-ng', scalingConfig={'minSize': 1, 'maxSize': 3, 'desiredSize': 2}, subnets=['subnet-123'], nodeRole='arn:aws:iam::123456789012:role/node'), {'clusterName': 'eks-unv-c', 'nodegroupName': 'unv-ng', 'version': '1.28'})[2],
        'CreateFargateProfile': lambda store: (store.create_cluster('eks-fp-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'clusterName': 'eks-fp-c', 'fargateProfileName': 'test-fp', 'podExecutionRoleArn': 'arn:aws:iam::123456789012:role/fargate', 'selectors': [{'namespace': 'default'}]})[1],
        'DescribeFargateProfile': lambda store: (store.create_cluster('eks-dfp-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_fargate_profile('eks-dfp-c', 'dfp-fp', podExecutionRoleArn='arn:aws:iam::123456789012:role/fargate', selectors=[{'namespace': 'default'}]), {'clusterName': 'eks-dfp-c', 'fargateProfileName': 'dfp-fp'})[2],
        'DeleteFargateProfile': lambda store: (store.create_cluster('eks-delfp-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_fargate_profile('eks-delfp-c', 'delfp', podExecutionRoleArn='arn:aws:iam::123456789012:role/fargate', selectors=[{'namespace': 'default'}]), {'clusterName': 'eks-delfp-c', 'fargateProfileName': 'delfp'})[2],
        'ListFargateProfiles': {'clusterName': 'eks-test-cluster'},
        'CreateAddon': lambda store: (store.create_cluster('eks-add-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'clusterName': 'eks-add-c', 'addonName': 'vpc-cni'})[1],
        'DescribeAddon': lambda store: (store.create_cluster('eks-dad-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_addon('eks-dad-c', 'vpc-cni', addonVersion='v1.18'), {'clusterName': 'eks-dad-c', 'addonName': 'vpc-cni'})[2],
        'DeleteAddon': lambda store: (store.create_cluster('eks-delad-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_addon('eks-delad-c', 'vpc-cni', addonVersion='v1.18'), {'clusterName': 'eks-delad-c', 'addonName': 'vpc-cni'})[2],
        'ListAddons': {'clusterName': 'eks-test-cluster'},
        'UpdateAddon': lambda store: (store.create_cluster('eks-uad-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_addon('eks-uad-c', 'vpc-cni', addonVersion='v1.18'), {'clusterName': 'eks-uad-c', 'addonName': 'vpc-cni', 'addonVersion': 'v1.19'})[2],
        'CreateAccessEntry': lambda store: (store.create_cluster('eks-ace-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'clusterName': 'eks-ace-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal'})[1],
        'DescribeAccessEntry': lambda store: (store.create_cluster('eks-dae-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_access_entry('eks-dae-c', 'arn:aws:iam::123456789012:role/test-principal'), {'clusterName': 'eks-dae-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal'})[2],
        'DeleteAccessEntry': lambda store: (store.create_cluster('eks-delae-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_access_entry('eks-delae-c', 'arn:aws:iam::123456789012:role/test-principal'), {'clusterName': 'eks-delae-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal'})[2],
        'UpdateAccessEntry': lambda store: (store.create_cluster('eks-uae-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_access_entry('eks-uae-c', 'arn:aws:iam::123456789012:role/test-principal'), {'clusterName': 'eks-uae-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal', 'username': 'test-user'})[2],
        'ListAccessEntries': {'clusterName': 'eks-test-cluster'},
        'AssociateAccessPolicy': lambda store: (store.create_cluster('eks-aap-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_access_entry('eks-aap-c', 'arn:aws:iam::123456789012:role/test-principal'), {'clusterName': 'eks-aap-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal', 'policyArn': 'arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy', 'accessScope': {'type': 'cluster'}})[2],
        'DisassociateAccessPolicy': lambda store: (store.create_cluster('eks-dap-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_access_entry('eks-dap-c', 'arn:aws:iam::123456789012:role/test-principal'), store.associate_access_policy('eks-dap-c', 'arn:aws:iam::123456789012:role/test-principal', 'arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy'), {'clusterName': 'eks-dap-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal', 'policyArn': 'arn:aws:eks::aws:cluster-access-policy/AmazonEKSClusterAdminPolicy'})[3],
        'ListAssociatedAccessPolicies': lambda store: (store.create_cluster('eks-laap-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'clusterName': 'eks-laap-c', 'principalArn': 'arn:aws:iam::123456789012:role/test-principal'})[1],
        'DescribeUpdate': lambda store: (store.create_cluster('eks-du-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), upd := store.update_cluster_version('eks-du-c', '1.28'), {'name': 'eks-du-c', 'updateId': upd['update']['id']})[2],
        'ListUpdates': {'name': 'eks-test-cluster'},
        'eks.TagResource': lambda store: (store.create_cluster('eks-tag-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'resourceArn': store.describe_cluster('eks-tag-c')['cluster']['arn'], 'tags': {'env': 'test'}})[1],
        'eks.UntagResource': lambda store: (store.create_cluster('eks-untag-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'resourceArn': store.describe_cluster('eks-untag-c')['cluster']['arn'], 'tagKeys': ['env']})[1],
        'eks.ListTagsForResource': lambda store: (store.create_cluster('eks-ltfr-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), {'resourceArn': store.describe_cluster('eks-ltfr-c')['cluster']['arn']})[1],
        # ── rds ───────────────────────────────────────────────────────────
        'CreateDBInstance': {'DBInstanceIdentifier': 'rds-test-db', 'DBInstanceClass': 'db.t3.micro', 'Engine': 'mysql', 'MasterUsername': 'admin', 'MasterUserPassword': 'Password123!'},
        'DescribeDBInstances': {},
        'ModifyDBInstance': lambda store: (store.create_db_instance('rds-mod-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'DBInstanceIdentifier': 'rds-mod-db', 'DBInstanceClass': 'db.t3.small'})[1],
        'DeleteDBInstance': lambda store: (store.create_db_instance('rds-del-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'DBInstanceIdentifier': 'rds-del-db', 'SkipFinalSnapshot': True})[1],
        'RebootDBInstance': lambda store: (store.create_db_instance('rds-reboot-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'DBInstanceIdentifier': 'rds-reboot-db'})[1],
        'CreateDBCluster': {'DBClusterIdentifier': 'rds-test-cluster', 'Engine': 'aurora-mysql', 'MasterUsername': 'admin', 'MasterUserPassword': 'Password123!'},
        'DescribeDBClusters': {},
        'ModifyDBCluster': lambda store: (store.create_db_cluster('rds-mod-cl', 'aurora-mysql', master_username='admin', master_user_password='Password123!'), {'DBClusterIdentifier': 'rds-mod-cl', 'MasterUserPassword': 'NewPassword123!'})[1],
        'DeleteDBCluster': lambda store: (store.create_db_cluster('rds-del-cl', 'aurora-mysql', master_username='admin', master_user_password='Password123!'), {'DBClusterIdentifier': 'rds-del-cl', 'SkipFinalSnapshot': True})[1],
        'CreateDBSnapshot': lambda store: (store.create_db_instance('rds-snap-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'DBSnapshotIdentifier': 'rds-test-snap', 'DBInstanceIdentifier': 'rds-snap-db'})[1],
        'DescribeDBSnapshots': {},
        'DeleteDBSnapshot': lambda store: (store.create_db_instance('rds-dsnap-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), store.create_db_snapshot('rds-del-snap', 'rds-dsnap-db'), {'DBSnapshotIdentifier': 'rds-del-snap'})[2],
        'CreateDBParameterGroup': {'DBParameterGroupName': 'rds-test-pg', 'DBParameterGroupFamily': 'mysql8.0', 'Description': 'Test parameter group'},
        'DescribeDBParameterGroups': {},
        'ModifyDBParameterGroup': lambda store: (store.create_db_parameter_group('rds-mod-pg', 'mysql8.0', 'Test'), {'DBParameterGroupName': 'rds-mod-pg', 'Parameters': [{'ParameterName': 'max_connections', 'ParameterValue': '100'}]})[1],
        'DeleteDBParameterGroup': lambda store: (store.create_db_parameter_group('rds-del-pg', 'mysql8.0', 'Test'), {'DBParameterGroupName': 'rds-del-pg'})[1],
        'CreateDBClusterParameterGroup': {'DBClusterParameterGroupName': 'rds-test-cpg', 'DBParameterGroupFamily': 'aurora-mysql8.0', 'Description': 'Test cluster parameter group'},
        'DescribeDBClusterParameterGroups': {},
        'DeleteDBClusterParameterGroup': lambda store: (store.create_db_cluster_parameter_group('rds-del-cpg', 'aurora-mysql8.0', 'Test'), {'DBClusterParameterGroupName': 'rds-del-cpg'})[1],
        'CreateDBSubnetGroup': {'DBSubnetGroupName': 'rds-test-sng', 'DBSubnetGroupDescription': 'Test subnet group', 'SubnetIds': ['subnet-123']},
        'DescribeDBSubnetGroups': {},
        'DeleteDBSubnetGroup': lambda store: (store.create_db_subnet_group('rds-del-sng', 'Test subnet group', ['subnet-123']), {'DBSubnetGroupName': 'rds-del-sng'})[1],
        'rds.AddTagsToResource': lambda store: (store.create_db_instance('rds-tag-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'ResourceName': store.describe_db_instances('rds-tag-db')['DBInstanceArn'], 'Tags': [{'Key': 'env', 'Value': 'test'}]})[1],
        'rds.RemoveTagsFromResource': lambda store: (store.create_db_instance('rds-untag-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'ResourceName': store.describe_db_instances('rds-untag-db')['DBInstanceArn'], 'TagKeys': ['env']})[1],
        'rds.ListTagsForResource': lambda store: (store.create_db_instance('rds-ltfr-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'ResourceName': store.describe_db_instances('rds-ltfr-db')['DBInstanceArn']})[1],
        # ── globalaccelerator ─────────────────────────────────────────────
        'globalaccelerator.CreateAccelerator': {'Name': 'ga-test-accel', 'IdempotencyToken': 'ga-tok-1', 'IpAddressType': 'IPV4'},
        'globalaccelerator.DescribeAccelerator': lambda store: (r := store.create_accelerator(Name='ga-desc', IdempotencyToken='ga-desc-tok', IpAddressType='IPV4'), {'AcceleratorArn': r['Accelerator']['AcceleratorArn']})[1],
        'globalaccelerator.ListAccelerators': {},
        'globalaccelerator.UpdateAccelerator': lambda store: (r := store.create_accelerator(Name='ga-upd', IdempotencyToken='ga-upd-tok', IpAddressType='IPV4'), {'AcceleratorArn': r['Accelerator']['AcceleratorArn'], 'Name': 'ga-upd-renamed'})[1],
        'globalaccelerator.DeleteAccelerator': lambda store: (r := store.create_accelerator(Name='ga-del', IdempotencyToken='ga-del-tok', IpAddressType='IPV4', Enabled=False), {'AcceleratorArn': r['Accelerator']['AcceleratorArn']})[1],
        'globalaccelerator.DescribeAcceleratorAttributes': lambda store: (r := store.create_accelerator(Name='ga-attrs', IdempotencyToken='ga-attrs-tok', IpAddressType='IPV4'), {'AcceleratorArn': r['Accelerator']['AcceleratorArn']})[1],
        'globalaccelerator.UpdateAcceleratorAttributes': lambda store: (r := store.create_accelerator(Name='ga-upa', IdempotencyToken='ga-upa-tok', IpAddressType='IPV4'), {'AcceleratorArn': r['Accelerator']['AcceleratorArn'], 'FlowLogsEnabled': True})[1],
        'globalaccelerator.CreateListener': lambda store: (acc := store.create_accelerator(Name='ga-lis', IdempotencyToken='ga-lis-tok', IpAddressType='IPV4'), {'AcceleratorArn': acc['Accelerator']['AcceleratorArn'], 'PortRanges': [{'FromPort': 80, 'ToPort': 80}], 'Protocol': 'TCP'})[1],
        'globalaccelerator.DescribeListener': lambda store: (acc := store.create_accelerator(Name='ga-dlis', IdempotencyToken='ga-dlis-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), {'ListenerArn': lis['Listener']['ListenerArn']})[2],
        'globalaccelerator.ListListeners': lambda store: (acc := store.create_accelerator(Name='ga-llis', IdempotencyToken='ga-llis-tok', IpAddressType='IPV4'), {'AcceleratorArn': acc['Accelerator']['AcceleratorArn']})[1],
        'globalaccelerator.UpdateListener': lambda store: (acc := store.create_accelerator(Name='ga-ulis', IdempotencyToken='ga-ulis-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), {'ListenerArn': lis['Listener']['ListenerArn'], 'PortRanges': [{'FromPort': 443, 'ToPort': 443}], 'Protocol': 'TCP'})[2],
        'globalaccelerator.DeleteListener': lambda store: (acc := store.create_accelerator(Name='ga-dellis', IdempotencyToken='ga-dellis-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), {'ListenerArn': lis['Listener']['ListenerArn']})[2],
        'globalaccelerator.CreateEndpointGroup': lambda store: (acc := store.create_accelerator(Name='ga-eg', IdempotencyToken='ga-eg-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), {'ListenerArn': lis['Listener']['ListenerArn'], 'EndpointGroupRegion': 'us-east-1'})[2],
        'globalaccelerator.DescribeEndpointGroup': lambda store: (acc := store.create_accelerator(Name='ga-deg', IdempotencyToken='ga-deg-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), eg := store.create_endpoint_group(EndpointGroupRegion='us-east-1', ListenerArn=lis['Listener']['ListenerArn']), {'EndpointGroupArn': eg['EndpointGroup']['EndpointGroupArn']})[3],
        'globalaccelerator.ListEndpointGroups': lambda store: (acc := store.create_accelerator(Name='ga-leg', IdempotencyToken='ga-leg-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), {'ListenerArn': lis['Listener']['ListenerArn']})[2],
        'globalaccelerator.UpdateEndpointGroup': lambda store: (acc := store.create_accelerator(Name='ga-ueg', IdempotencyToken='ga-ueg-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), eg := store.create_endpoint_group(EndpointGroupRegion='us-east-1', ListenerArn=lis['Listener']['ListenerArn']), {'EndpointGroupArn': eg['EndpointGroup']['EndpointGroupArn'], 'HealthCheckPort': 8080})[3],
        'globalaccelerator.DeleteEndpointGroup': lambda store: (acc := store.create_accelerator(Name='ga-deleg', IdempotencyToken='ga-deleg-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), eg := store.create_endpoint_group(EndpointGroupRegion='us-east-1', ListenerArn=lis['Listener']['ListenerArn']), {'EndpointGroupArn': eg['EndpointGroup']['EndpointGroupArn']})[3],
        'globalaccelerator.AddEndpoints': lambda store: (acc := store.create_accelerator(Name='ga-ae', IdempotencyToken='ga-ae-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), eg := store.create_endpoint_group(EndpointGroupRegion='us-east-1', ListenerArn=lis['Listener']['ListenerArn']), {'EndpointGroupArn': eg['EndpointGroup']['EndpointGroupArn'], 'EndpointConfigurations': [{'EndpointId': 'ep-1', 'Weight': 128}]})[3],
        'globalaccelerator.RemoveEndpoints': lambda store: (acc := store.create_accelerator(Name='ga-re', IdempotencyToken='ga-re-tok', IpAddressType='IPV4'), lis := store.create_listener(AcceleratorArn=acc['Accelerator']['AcceleratorArn'], PortRanges=[{'FromPort': 80, 'ToPort': 80}], Protocol='TCP'), eg := store.create_endpoint_group(EndpointGroupRegion='us-east-1', ListenerArn=lis['Listener']['ListenerArn']), _ := store.add_endpoints(EndpointGroupArn=eg['EndpointGroup']['EndpointGroupArn'], EndpointConfigurations=[{'EndpointId': 'ep-1', 'Weight': 128}]), {'EndpointGroupArn': eg['EndpointGroup']['EndpointGroupArn'], 'EndpointIdentifiers': [{'EndpointId': 'ep-1'}]})[4],
        'globalaccelerator.TagResource': lambda store: (acc := store.create_accelerator(Name='ga-tag', IdempotencyToken='ga-tag-tok', IpAddressType='IPV4'), {'ResourceArn': acc['Accelerator']['AcceleratorArn'], 'Tags': [{'Key': 'env', 'Value': 'test'}]})[1],
        'globalaccelerator.UntagResource': lambda store: (acc := store.create_accelerator(Name='ga-untag', IdempotencyToken='ga-untag-tok', IpAddressType='IPV4'), {'ResourceArn': acc['Accelerator']['AcceleratorArn'], 'TagKeys': ['env']})[1],
        'globalaccelerator.ListTagsForResource': lambda store: (acc := store.create_accelerator(Name='ga-ltfr', IdempotencyToken='ga-ltfr-tok', IpAddressType='IPV4'), {'ResourceArn': acc['Accelerator']['AcceleratorArn']})[1],
        # ── personalize ───────────────────────────────────────────────────
        'personalize.CreateDataset': {'name': 'pers-test-ds', 'schemaArn': 'arn:aws:personalize:us-east-1:123456789012:schema/test', 'datasetGroupArn': 'arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', 'datasetType': 'Interactions'},
        'personalize.DescribeDataset': lambda store: (r := store.create_dataset('pers-desc-ds', schemaArn='arn:aws:personalize:us-east-1:123456789012:schema/test', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', datasetType='Interactions'), {'datasetArn': r.datasetArn})[1],
        'personalize.ListDatasets': {},
        'personalize.UpdateDataset': lambda store: (r := store.create_dataset('pers-upd-ds', schemaArn='arn:aws:personalize:us-east-1:123456789012:schema/test', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', datasetType='Interactions'), {'datasetArn': r.datasetArn, 'schemaArn': 'arn:aws:personalize:us-east-1:123456789012:schema/test2'})[1],
        'personalize.DeleteDataset': lambda store: (r := store.create_dataset('pers-del-ds', schemaArn='arn:aws:personalize:us-east-1:123456789012:schema/test', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', datasetType='Interactions'), {'datasetArn': r.datasetArn})[1],
        'personalize.CreateSolution': {'name': 'pers-test-sol', 'datasetGroupArn': 'arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', 'recipeArn': 'arn:aws:personalize:::recipe/aws-hrnn'},
        'personalize.DescribeSolution': lambda store: (r := store.create_solution('pers-desc-sol', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', recipeArn='arn:aws:personalize:::recipe/aws-hrnn'), {'solutionArn': r.solutionArn})[1],
        'personalize.ListSolutions': {},
        'personalize.DeleteSolution': lambda store: (r := store.create_solution('pers-del-sol', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', recipeArn='arn:aws:personalize:::recipe/aws-hrnn'), {'solutionArn': r.solutionArn})[1],
        'personalize.CreateCampaign': {'name': 'pers-test-camp', 'solutionVersionArn': 'arn:aws:personalize:us-east-1:123456789012:solution-version/test-sv'},
        'personalize.DescribeCampaign': lambda store: (r := store.create_campaign('pers-desc-camp', solutionVersionArn='arn:aws:personalize:us-east-1:123456789012:solution-version/test-sv'), {'campaignArn': r.campaignArn})[1],
        'personalize.ListCampaigns': {},
        'personalize.UpdateCampaign': lambda store: (r := store.create_campaign('pers-upd-camp', solutionVersionArn='arn:aws:personalize:us-east-1:123456789012:solution-version/test-sv'), {'campaignArn': r.campaignArn, 'minProvisionedTPS': 5})[1],
        'personalize.DeleteCampaign': lambda store: (r := store.create_campaign('pers-del-camp', solutionVersionArn='arn:aws:personalize:us-east-1:123456789012:solution-version/test-sv'), {'campaignArn': r.campaignArn})[1],
        'personalize.TagResource': lambda store: (r := store.create_dataset('pers-tag-ds', schemaArn='arn:aws:personalize:us-east-1:123456789012:schema/test', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', datasetType='Interactions'), {'resourceArn': r.datasetArn, 'tags': [{'tagKey': 'env', 'tagValue': 'test'}]})[1],
        'personalize.UntagResource': lambda store: (r := store.create_dataset('pers-untag-ds', schemaArn='arn:aws:personalize:us-east-1:123456789012:schema/test', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', datasetType='Interactions'), {'resourceArn': r.datasetArn, 'tagKeys': ['env']})[1],
        'personalize.ListTagsForResource': lambda store: (r := store.create_dataset('pers-ltfr-ds', schemaArn='arn:aws:personalize:us-east-1:123456789012:schema/test', datasetGroupArn='arn:aws:personalize:us-east-1:123456789012:dataset-group/test-dg', datasetType='Interactions'), {'resourceArn': r.datasetArn})[1],
        # ── rolesanywhere ─────────────────────────────────────────────────
        ...
        'rolesanywhere.CreateTrustAnchor': {'name': 'ra-test-ta', 'source': {'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}},
        'rolesanywhere.GetTrustAnchor': lambda store: (r := store.create_trust_anchor('ra-get-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'trustAnchorId': r.trustAnchorId})[1],
        'rolesanywhere.ListTrustAnchors': {},
        'rolesanywhere.UpdateTrustAnchor': lambda store: (r := store.create_trust_anchor('ra-upd-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'trustAnchorId': r.trustAnchorId, 'name': 'updated-ta'})[1],
        'rolesanywhere.DeleteTrustAnchor': lambda store: (r := store.create_trust_anchor('ra-del-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'trustAnchorId': r.trustAnchorId})[1],
        'rolesanywhere.EnableTrustAnchor': lambda store: (r := store.create_trust_anchor('ra-en-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}, enabled=False), {'trustAnchorId': r.trustAnchorId})[1],
        'rolesanywhere.DisableTrustAnchor': lambda store: (r := store.create_trust_anchor('ra-dis-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'trustAnchorId': r.trustAnchorId})[1],
        'rolesanywhere.ImportCrl': {'name': 'ra-test-crl', 'crlData': 'base64-crl-data', 'trustAnchorArn': 'arn:aws:rolesanywhere:us-east-1:123456789012:trust-anchor/test-ta'},
        'rolesanywhere.GetCrl': lambda store: (r := store.import_crl('ra-get-crl', 'base64-crl-data', trustAnchorArn='arn:aws:rolesanywhere:us-east-1:123456789012:trust-anchor/test-ta'), {'crlId': r.crlId})[1],
        'rolesanywhere.ListCrls': {},
        'rolesanywhere.UpdateCrl': lambda store: (r := store.import_crl('ra-upd-crl', 'base64-crl-data', trustAnchorArn='arn:aws:rolesanywhere:us-east-1:123456789012:trust-anchor/test-ta'), {'crlId': r.crlId, 'name': 'updated-crl'})[1],
        'rolesanywhere.DeleteCrl': lambda store: (r := store.import_crl('ra-del-crl', 'base64-crl-data', trustAnchorArn='arn:aws:rolesanywhere:us-east-1:123456789012:trust-anchor/test-ta'), {'crlId': r.crlId})[1],
        'rolesanywhere.EnableCrl': lambda store: (r := store.import_crl('ra-en-crl', 'base64-crl-data', trustAnchorArn='arn:aws:rolesanywhere:us-east-1:123456789012:trust-anchor/test-ta', enabled=False), {'crlId': r.crlId})[1],
        'rolesanywhere.DisableCrl': lambda store: (r := store.import_crl('ra-dis-crl', 'base64-crl-data', trustAnchorArn='arn:aws:rolesanywhere:us-east-1:123456789012:trust-anchor/test-ta'), {'crlId': r.crlId})[1],
        'rolesanywhere.GetSubject': lambda store: (r := store.create_trust_anchor('ra-subj-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'subjectId': 'test-subject'})[1],
        'rolesanywhere.ListSubjects': {},
        'rolesanywhere.TagResource': lambda store: (r := store.create_profile('ra-tag-prof', roleArns=['arn:aws:iam::123456789012:role/test']), {'resourceArn': r.profileArn, 'tags': [{'key': 'env', 'value': 'test'}]})[1],
        'rolesanywhere.UntagResource': lambda store: (r := store.create_profile('ra-untag-prof', roleArns=['arn:aws:iam::123456789012:role/test']), {'resourceArn': r.profileArn, 'tagKeys': ['env']})[1],
        'rolesanywhere.ListTagsForResource': lambda store: (r := store.create_profile('ra-ltfr-prof', roleArns=['arn:aws:iam::123456789012:role/test']), {'resourceArn': r.profileArn})[1],
        'rolesanywhere.PutAttributeMapping': lambda store: (r := store.create_profile('ra-pam-prof', roleArns=['arn:aws:iam::123456789012:role/test']), {'profileId': r.profileId, 'certificateField': 'x509Subject', 'mappingRules': [{'field': 'x509Subject/CN'}]})[1],
        'rolesanywhere.DeleteAttributeMapping': lambda store: (r := store.create_profile('ra-dam-prof', roleArns=['arn:aws:iam::123456789012:role/test']), r2 := store.put_attribute_mapping(r.profileId, 'x509Subject', [{'field': 'x509Subject/CN'}]), {'profileId': r.profileId, 'certificateField': 'x509Subject'})[2],
        'rolesanywhere.PutNotificationSettings': lambda store: (r := store.create_trust_anchor('ra-pns-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'trustAnchorId': r.trustAnchorId, 'notificationSettings': {'enabled': True, 'channelArn': 'arn:aws:sns:us-east-1:123456789012:test-topic'}})[1],
        'rolesanywhere.ResetNotificationSettings': lambda store: (r := store.create_trust_anchor('ra-rns-ta', source={'sourceType': 'AWS_ACM_PCA', 'sourceData': {'acmPcaArn': 'arn:aws:acm-pca:us-east-1:123456789012:certificate-authority/test-ca'}}), {'trustAnchorId': r.trustAnchorId})[1],
        # ── acm ───────────────────────────────────────────────────────────
        'RequestCertificate': {'DomainName': 'acm-test.example.com'},
        'ImportCertificate': {'Certificate': 'base64-cert-data', 'PrivateKey': 'base64-key-data'},
        'DescribeCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn']})[1],
        'GetCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn']})[1],
        'ListCertificates': {},
        'DeleteCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn']})[1],
        'UpdateCertificateOptions': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn'], 'Options': {'CertificateTransparencyLoggingPreference': 'ENABLED'}})[1],
        'ListTagsForCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn']})[1],
        'AddTagsToCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn'], 'Tags': [{'Key': 'env', 'Value': 'test'}]})[1],
        'RemoveTagsFromCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data', Tags=[{'Key': 'env', 'Value': 'test'}]), {'CertificateArn': r['CertificateArn'], 'Tags': [{'Key': 'env', 'Value': 'test'}], 'TagKeys': ['env']})[1],
        'RenewCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), [setattr(v, 'Status', 'ISSUED') for v in store._certificates.values()], {'CertificateArn': r['CertificateArn']})[2],
        'RevokeCertificate': lambda store: (r := store.import_certificate(Certificate='base64-cert-data', PrivateKey='base64-key-data'), {'CertificateArn': r['CertificateArn'], 'RevocationReason': 'UNSPECIFIED'})[1],
        ...
        'ResendValidationEmail': lambda store: (r := store.request_certificate('acm-test.example.com'), {'CertificateArn': r['CertificateArn'], 'Domain': 'test.example.com', 'ValidationDomain': 'test.example.com'})[1],
        'GetAccountConfiguration': {},
        'PutAccountConfiguration': {'ExpiryEvents': {'DaysBeforeExpiry': 7}},
        # ── batch ─────────────────────────────────────────────────────────
        'batch.CreateComputeEnvironment': {'computeEnvironmentName': 'batch-test-ce', 'type': 'MANAGED', 'computeResources': {'type': 'EC2', 'minvCpus': 0, 'maxvCpus': 16, 'desiredvCpus': 0, 'instanceTypes': ['optimal'], 'subnets': ['subnet-123'], 'securityGroupIds': ['sg-123'], 'instanceRole': 'arn:aws:iam::123456789012:instance-profile/ecsInstanceRole'}, 'serviceRole': 'arn:aws:iam::123456789012:role/AWSBatchServiceRole'},
        'batch.DescribeComputeEnvironments': {},
        'batch.UpdateComputeEnvironment': lambda store: (store.create_compute_environment('batch-upd-ce', 'MANAGED', compute_resources={'type': 'EC2', 'minvCpus': 0, 'maxvCpus': 16, 'desiredvCpus': 0, 'instanceTypes': ['optimal'], 'subnets': ['subnet-123'], 'securityGroupIds': ['sg-123'], 'instanceRole': 'arn', 'ec2KeyPair': ''}, service_role='arn'), {'computeEnvironment': 'batch-upd-ce', 'state': 'DISABLED'})[1],
        'batch.DeleteComputeEnvironment': lambda store: (store.create_compute_environment('batch-del-ce', 'MANAGED', compute_resources={'type': 'EC2', 'minvCpus': 0, 'maxvCpus': 16, 'desiredvCpus': 0, 'instanceTypes': ['optimal'], 'subnets': ['subnet-123'], 'securityGroupIds': ['sg-123'], 'instanceRole': 'arn', 'ec2KeyPair': ''}, service_role='arn'), {'computeEnvironment': 'batch-del-ce'})[1],
        'batch.CreateJobQueue': {'jobQueueName': 'batch-test-jq', 'state': 'ENABLED', 'priority': 1, 'computeEnvironmentOrder': [{'computeEnvironment': 'batch-test-ce', 'order': 1}]},
        'batch.DescribeJobQueues': {},
        'batch.UpdateJobQueue': lambda store: (store.create_job_queue('batch-upd-jq', state='ENABLED', priority=1, compute_environment_order=[{'computeEnvironment': 'batch-test-ce', 'order': 1}]), {'jobQueue': 'batch-upd-jq', 'state': 'DISABLED'})[1],
        'batch.DeleteJobQueue': lambda store: (store.create_job_queue('batch-del-jq', state='ENABLED', priority=1, compute_environment_order=[{'computeEnvironment': 'batch-test-ce', 'order': 1}]), {'jobQueue': 'batch-del-jq'})[1],
        'batch.RegisterJobDefinition': {'jobDefinitionName': 'batch-test-jd', 'type': 'container', 'containerProperties': {'image': 'busybox', 'command': ['echo', 'hello'], 'vcpus': 1, 'memory': 128}},
        'batch.DescribeJobDefinitions': {},
        'batch.DeregisterJobDefinition': lambda store: (store.register_job_definition('batch-del-jd', 'container', container_properties={'image': 'busybox', 'command': ['echo'], 'vcpus': 1, 'memory': 128}), {'jobDefinition': store._job_definitions['batch-del-jd'][0].job_definition_arn})[1],
        'batch.SubmitJob': {'jobName': 'batch-test-job', 'jobQueue': 'batch-test-jq', 'jobDefinition': 'batch-test-jd:1'},
        'batch.DescribeJobs': {'jobs': ['job-1']},
        'batch.ListJobs': {},
        'batch.TerminateJob': lambda store: (store.submit_job('test-job', 'batch-test-jq', 'batch-test-jd:1', job_id='job-1'), {'jobId': 'job-1', 'reason': 'test termination'})[1],
        'batch.CancelJob': lambda store: (store.submit_job('test-job', 'batch-test-jq', 'batch-test-jd:1', job_id='job-1'), {'jobId': 'job-1', 'reason': 'test cancel'})[1],
        'batch.CreateSchedulingPolicy': {'name': 'batch-test-sp', 'fairsharePolicy': {'shareDecaySeconds': 3600, 'computeReservation': 50, 'shareDistribution': [{'shareIdentifier': 'A', 'weightFactor': 0.5}]}},
        'batch.DescribeSchedulingPolicies': {'arns': ['arn:aws:batch:us-east-1:123456789012:scheduling-policy/batch-test-sp']},
        'batch.ListSchedulingPolicies': {},
        'batch.UpdateSchedulingPolicy': lambda store: (store.create_scheduling_policy('batch-upd-sp', fairshare_policy={'shareDecaySeconds': 3600, 'computeReservation': 50, 'shareDistribution': [{'shareIdentifier': 'A', 'weightFactor': 0.5}]}), {'arn': store._scheduling_policies['batch-upd-sp'].arn, 'fairsharePolicy': {'shareDecaySeconds': 7200}})[1],
        'batch.DeleteSchedulingPolicy': lambda store: (store.create_scheduling_policy('batch-del-sp', fairshare_policy={'shareDecaySeconds': 3600, 'computeReservation': 50, 'shareDistribution': [{'shareIdentifier': 'A', 'weightFactor': 0.5}]}), {'arn': store._scheduling_policies['batch-del-sp'].arn})[1],
        'batch.TagResource': lambda store: (store.create_compute_environment('batch-tag-ce', 'MANAGED', compute_resources={'type': 'EC2', 'minvCpus': 0, 'maxvCpus': 16, 'desiredvCpus': 0, 'instanceTypes': ['optimal'], 'subnets': ['subnet-123'], 'securityGroupIds': ['sg-123'], 'instanceRole': 'arn', 'ec2KeyPair': ''}, service_role='arn'), {'resourceArn': store._compute_environments['batch-tag-ce'].compute_environment_arn, 'tags': {'env': 'test'}})[1],
        'batch.UntagResource': lambda store: (store.create_compute_environment('batch-untag-ce', 'MANAGED', compute_resources={'type': 'EC2', 'minvCpus': 0, 'maxvCpus': 16, 'desiredvCpus': 0, 'instanceTypes': ['optimal'], 'subnets': ['subnet-123'], 'securityGroupIds': ['sg-123'], 'instanceRole': 'arn', 'ec2KeyPair': ''}, service_role='arn', tags={'env': 'test'}), {'resourceArn': store._compute_environments['batch-untag-ce'].compute_environment_arn, 'tagKeys': ['env']})[1],
        'batch.ListTagsForResource': lambda store: (store.create_compute_environment('batch-ltfr-ce', 'MANAGED', compute_resources={'type': 'EC2', 'minvCpus': 0, 'maxvCpus': 16, 'desiredvCpus': 0, 'instanceTypes': ['optimal'], 'subnets': ['subnet-123'], 'securityGroupIds': ['sg-123'], 'instanceRole': 'arn', 'ec2KeyPair': ''}, service_role='arn'), {'resourceArn': store._compute_environments['batch-ltfr-ce'].compute_environment_arn})[1],
        # ── bedrock-runtime ──────────────────────────────────────────────
        'bedrock-runtime.StartAsyncInvoke': {'modelId': 'anthropic.claude-v2', 'modelInput': {}, 'outputDataConfig': {'s3OutputDataConfig': {'s3Uri': 's3://test-bucket/output/'}}},
        'bedrock-runtime.GetAsyncInvoke': lambda store: (r := store.start_async_invoke(modelId='anthropic.claude-v2', modelInput={}, outputDataConfig={'s3OutputDataConfig': {'s3Uri': 's3://test-bucket/output/'}}), {'invocationArn': r['invocationArn']})[1],
        'bedrock-runtime.ListAsyncInvokes': {},
        # ── application-autoscaling ──────────────────────────────────────
        'application-autoscaling.RegisterScalableTarget': {'ResourceId': 'service/ecs-cluster/test-service', 'ScalableDimension': 'ecs:service:DesiredCount', 'ServiceNamespace': 'ecs', 'MinCapacity': 1, 'MaxCapacity': 10},
        'application-autoscaling.DescribeScalableTargets': {'ServiceNamespace': 'ecs'},
        'application-autoscaling.DeregisterScalableTarget': lambda store: (store.register_target('asg-del-tgt', 'ecs', 'ecs:service:DesiredCount', 1, 10), {'ResourceId': 'asg-del-tgt', 'ScalableDimension': 'ecs:service:DesiredCount', 'ServiceNamespace': 'ecs'})[1],
        'application-autoscaling.PutScalingPolicy': {'PolicyName': 'asg-test-policy', 'ResourceId': 'service/ecs-cluster/test-service', 'ScalableDimension': 'ecs:service:DesiredCount', 'ServiceNamespace': 'ecs', 'PolicyType': 'TargetTrackingScaling', 'TargetTrackingScalingPolicyConfiguration': {'TargetValue': 75.0, 'PredefinedMetricSpecification': {'PredefinedMetricType': 'ECSServiceAverageCPUUtilization'}, 'ScaleOutCooldown': 60, 'ScaleInCooldown': 60}},
        'application-autoscaling.DescribeScalingPolicies': {'ServiceNamespace': 'ecs'},
        'application-autoscaling.DeleteScalingPolicy': lambda store: (store.register_target('asg-delpol-tgt', 'ecs', 'ecs:service:DesiredCount', 1, 10), store.put_policy('asg-del-pol', 'asg-delpol-tgt', 'ecs', 'ecs:service:DesiredCount', 'TargetTrackingScaling', TargetTrackingScalingPolicyConfiguration={'TargetValue': 75.0, 'PredefinedMetricSpecification': {'PredefinedMetricType': 'ECSServiceAverageCPUUtilization'}}), {'PolicyName': 'asg-del-pol', 'ResourceId': 'asg-delpol-tgt', 'ScalableDimension': 'ecs:service:DesiredCount', 'ServiceNamespace': 'ecs'})[2],
        # ── iot-data ─────────────────────────────────────────────────────
        'iot-data.GetThingShadow': lambda store: (store.update_thing_shadow('iot-test-thing', b'{"state":{}}'), {'thingName': 'iot-test-thing'})[1],
        'iot-data.UpdateThingShadow': {'thingName': 'iot-test-thing', 'payload': b'{"state":{"desired":{"color":"green"}}}'},
        'iot-data.DeleteThingShadow': lambda store: (store.update_thing_shadow('iot-test-del', b'{"state":{}}'), {'thingName': 'iot-test-del'})[1],
        'iot-data.ListNamedShadowsForThing': {'thingName': 'iot-test-thing'},
        'iot-data.GetRetainedMessage': lambda store: (store.__class__._retained.__setitem__('test/topic', {'topic': 'test/topic', 'payload': b'hello', 'qos': 1}), {'topic': 'test/topic'})[1],
        'iot-data.ListRetainedMessages': {},
        'iot-data.Publish': {'topic': 'test/topic', 'payload': b'hello', 'qos': 1},
        'iot-data.DeleteRetainedMessage': lambda store: (store.__class__._retained.__setitem__('test/del-topic', {'topic': 'test/del-topic', 'payload': b'hello', 'qos': 1}), {'topic': 'test/del-topic'})[1],
