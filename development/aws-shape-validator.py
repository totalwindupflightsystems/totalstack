...
def _call_handler(service: str, op_name: str, handler, store) -> dict:
    ...
    test_inputs = {
        ...
        'DescribeFargateProfile': lambda store: (store.create_cluster('eks-dfp-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_fargate_profile('dfp-fp', 'eks-dfp-c', podExecutionRoleArn='arn:aws:iam::123456789012:role/fargate', selectors=[{'namespace': 'default'}]), {'clusterName': 'eks-dfp-c', 'fargateProfileName': 'dfp-fp'})[2],
        'DeleteFargateProfile': lambda store: (store.create_cluster('eks-delfp-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_fargate_profile('delfp', 'eks-delfp-c', podExecutionRoleArn='arn:aws:iam::123456789012:role/fargate', selectors=[{'namespace': 'default'}]), {'clusterName': 'eks-delfp-c', 'fargateProfileName': 'delfp'})[2],
        ...
        'DescribeAddon': lambda store: (store.create_cluster('eks-dad-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_addon('vpc-cni', 'eks-dad-c', addonVersion='v1.18'), {'clusterName': 'eks-dad-c', 'addonName': 'vpc-cni'})[2],
        'DeleteAddon': lambda store: (store.create_cluster('eks-delad-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_addon('vpc-cni', 'eks-delad-c', addonVersion='v1.18'), {'clusterName': 'eks-delad-c', 'addonName': 'vpc-cni'})[2],
        'ListAddons': {'clusterName': 'eks-test-cluster'},
        'UpdateAddon': lambda store: (store.create_cluster('eks-uad-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.create_addon('vpc-cni', 'eks-uad-c', addonVersion='v1.18'), {'clusterName': 'eks-uad-c', 'addonName': 'vpc-cni', 'addonVersion': 'v1.19'})[2],
        ...
        'DescribeUpdate': lambda store: (store.create_cluster('eks-du-c', roleArn='arn:aws:iam::123456789012:role/eks', resourcesVpcConfig={'subnetIds': ['subnet-123'], 'securityGroupIds': ['sg-123']}), store.update_cluster_version('eks-du-c', '1.28'), {'name': 'eks-du-c', 'updateId': store.describe_cluster('eks-du-c').updates[0].updateId if hasattr(store.describe_cluster('eks-du-c'), 'updates') and store.describe_cluster('eks-du-c').updates else 'test-update'})[2],
        ...
        'rds.AddTagsToResource': lambda store: (store.create_db_instance('rds-tag-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'ResourceName': store.describe_db_instances('rds-tag-db')[0]['DBInstanceArn'], 'Tags': [{'Key': 'env', 'Value': 'test'}]})[1],
        'rds.RemoveTagsFromResource': lambda store: (store.create_db_instance('rds-untag-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'ResourceName': store.describe_db_instances('rds-untag-db')[0]['DBInstanceArn'], 'TagKeys': ['env']})[1],
        'rds.ListTagsForResource': lambda store: (store.create_db_instance('rds-ltfr-db', 'db.t3.micro', 'mysql', master_username='admin', master_user_password='Password123!'), {'ResourceName': store.describe_db_instances('rds-ltfr-db')[0]['DBInstanceArn']})[1],
        # ── globalaccelerator ─────────────────────────────────────────────
